(module backalley-51e1eb01-c2e4-4713-af9a-c96e1bca208d GOVERNANCE
  ...
  (defconst POOL_ID:string "51e1eb01-c2e4-4713-af9a-c96e1bca208d"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-51e1eb01-c2e4-4713-af9a-c96e1bca208d"
  ...
  (defconst END_DATE:time (time "2022-02-11T04:55:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T04:55:00Z")
