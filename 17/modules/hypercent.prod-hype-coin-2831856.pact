(module prod-hype-coin 'hyper-admin-multi-keyset-prod
  ...
  (bless "AiTx1-TCXCifNh76GICNveoa4NsCbChWexTtpWlIUBE")
  (bless "ekFfhOL59jLtEu9nOSRhxYny6w2dQ6KmhE0Y-GGzxO0")
  (bless "Hr_J0il6VvfCzRDPDhDUvjpvY7FOhsfxV_RlprStRxc")
  (bless "tc_B42gkyf25EhcVDsVYFo5EtDsYzAhgaLOmEXciwv0")
  (bless "_wsLlxK5i8duhXZ3i7FnIuHeKqxQf4GLO-gVhejAduk")
  (bless "neCvtuYFkqz1KwcFh6N1Z9fkIDSVodJFlRZeLQycqRs")
  (bless "YGrPbZBNTF7APzrj3fUyewOCEhwhrHb3Nx5dkha-cKM")
  ...
  (defun genesis-guard () (keyset-ref-guard "hyper-admin-multi-keyset-prod"))
  ...
  (defcap IS_ADMIN ()
    (enforce-keyset (keyset-ref-guard "hyper-admin-multi-keyset-prod")))
