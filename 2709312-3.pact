(module backalley-179f427b-bc57-416a-a9df-be976472cee8 GOVERNANCE
  ...
  (defconst POOL_ID:string "179f427b-bc57-416a-a9df-be976472cee8"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-179f427b-bc57-416a-a9df-be976472cee8"
  ...
  (defconst START_DATE:time (time "2022-02-09T14:45:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-09T14:55:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-09T14:55:00Z")
