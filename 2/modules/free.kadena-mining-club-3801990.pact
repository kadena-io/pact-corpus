...
; ============================================
    ...
    (defun edit-founders-market-price (account:string nft-id:string new-price:decimal)
        ...
        (with-capability (ACCOUNT_GUARD account) 
            (if (get-founder-for-sale-true-false) (update fledger nft-id { "market-price": new-price } ) (format "NFT is not for sale, please list it on the marketplace before trying to edit the price"))
        )
    )
