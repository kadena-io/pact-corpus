...
; ============================================
    ...
    (defun coin-test (account:string guard:guard)
...
; ============================================
    ...
    (defun turn-on-miner (nft-id:string account:string)
        (require-capability (PRIVATE))
    ...
    (defun turn-on-miner1 (nft-id:string account:string guard:guard)
        (require-capability (PRIVATE))
