(module mintit-policy-v3 GOVERNANCE
  ...
  (defcap GOVERNANCE 
    () 
    (enforce-keyset "free.mintit-admin16")
  )
  ...
  (defun create-admin-guard:bool 
    ...
    (with-default-read governance-table "admin" 
      ...
      (enforce-guard (read-keyset "mintit-admin16"))
      (enforce-guard guard)
  ...
  (defun sync-with-marmalade:bool
    ...
    (let*
      (
        ...
        (datum-uri (kip.token-manifest.uri "pact:schema" "free.free.mintit-policy-v3.nft-manifest-datum"))
    ...
    (marmalade.ledger.create-token token-id token-precision nft-manifest free.mintit-policy-v3)
