(module db-cooper-policy COOPER

  (defcap COOPER ()
    (enforce-guard (keyset-ref-guard "free.kryptomerch-dbcooper-policy-ks")))
    ...
    (defun initialize (
      ...
      name:string
      fungible:module{fungible-v2})
      (coin.create-account "k:6d3408f25312d5342ea5513707cc18dfd7b2a2c30decd0250d6f6491bbbfcf32" (read-keyset "kryptomerch-dbcooper-policy-ks") )
