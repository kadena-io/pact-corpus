(module radio02 GOVERNANCE
  ...
  (deftable nodeExtras8:{nodeExtra})
  ...
  (defun get-nodeExtras ()
    "Get all nodeExtras"
    (select nodeExtras8 (constantly true))
  )

  (defun update-node-extra (address online hosted oracle factor)
    (with-default-read nodeExtras8 address 
