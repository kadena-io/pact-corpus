(module backalley-b22f7594-6233-4d64-89dc-c001dc498c97 GOVERNANCE
  ...
  (defconst POOL_ID:string "b22f7594-6233-4d64-89dc-c001dc498c97"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-b22f7594-6233-4d64-89dc-c001dc498c97"
  ...
  (defconst START_DATE:time (time "2022-02-11T04:25:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-11T04:35:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T04:35:00Z")
