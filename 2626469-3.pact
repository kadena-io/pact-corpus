(module backalley-d717bd03-429e-45ad-8ef8-ad51d8faa540 GOVERNANCE
  ...
  (defconst POOL_ID:string "d717bd03-429e-45ad-8ef8-ad51d8faa540"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-d717bd03-429e-45ad-8ef8-ad51d8faa540"
  ...
  (defconst START_DATE:time (time "2022-01-21T01:35:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-21T01:45:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-21T01:55:00Z")
