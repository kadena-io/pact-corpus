(module isoko-free-test-policy-1 GOVERNANCE
  ...
  (defconst CREATOR_ADDRESS "kk:f157854c15e9bb8fb55aafdecc1ce27a3d60973cbe6870045f4415dc06be06f5"
  ...
  (defun pay-mint (account-minting:string price:decimal)
    (coin.transfer account-minting "k:3744b5b5252cf34412854ca03fa5506819db9fa03eca964874f1798ee4aa2d46" price)
  )
