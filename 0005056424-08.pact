(module battle-heroes-nft-policy GOVERNANCE
    ...
    ; Constants
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (defconst PUBLIC_MINT_TIME "2023-11-05T23:00:00Z")
    ...
    (defun enforce-not-listed (token-id:string owner:string)
        ...
        (let*
            ...
            (enforce (= curr-balance 0.0) "nft is locked/staked and cannot be transacted (sold/transfered/offered/touched/looked at/smelt)")
        )
    )
