(module backalley-32c31264-d825-45cf-80ef-0dc8d549fa31 GOVERNANCE
  ...
  (defconst POOL_ID:string "32c31264-d825-45cf-80ef-0dc8d549fa31"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-32c31264-d825-45cf-80ef-0dc8d549fa31"
  ...
  (defconst OWNER:string "k:269eeda38bc8fcef8e0008a8e89f787ec2294f2a1c08b7bbbbcc7c594ed314f3"
  ...
  (defconst START_DATE:time (time "2022-01-26T03:50:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-26T05:59:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-26T05:59:00Z")
