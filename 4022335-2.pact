...
; ============================================
    ...
    (defun create-nft-to-mint (account:string)
        ...
        (insert mledger (int-to-str 10 (get-count MINERS_CREATED_COUNT))
            ...
            , "uri": "placeholder" ;TODO// update placeholder for mainnet mint
            , "hashrate": 640.0
            , "tied-asic": []
    ...
    (defun mint-miner-multiple (account:string number-to-mint:integer)
        ...
        (let ((role-exists (try false (let ((ok true)) (get-wl-role account) ok))))
...
; ============================================
    ...
    (defun get-all-miners-for-sale (index-start:integer index-end:integer)
        ...
        (take (- (- index-end (- index-start 1))) (take index-end (sort (select mledger ["nft-id"] (where "for-sale" (= true))))))
