(module ttest-token GOVERNANCE

  @doc " ttest-token is a new token implemented on the Kadena mainnet \
  ...
  (defconst INITIAL_SUPPLY:decimal 5000.0
    " Initial supply of 100,000 tokens. (5000 x20 chains)")
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "ttest-token"))
