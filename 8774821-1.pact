(module kda-skellies-testnet GOV
	...
	(defconst STAKING_END_TIME "2023-11-13T22:20:00Z")
    ...
    (defun calculate-reward (stakedTime:time)
        ...
        (enforce (<= (at "block-time" (chain-data)) (time STAKING_END_TIME)) ceiling (* (/ (diff-time (at "block-time" (chain-data)) stakedTime) 86400) 0.02) 6)
    )	
