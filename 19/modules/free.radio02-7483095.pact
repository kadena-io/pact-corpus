...
;     hashedPw: string
  ...
  (defschema subscriptionMenu
    ...
    periodUnit:string
    periodMeasure:integer
    value:decimal
    valueUnit:string
    paidIn:string
  )    
  (deftable subscriptionMenu1:{subscriptionMenu})
  ...
  (defun insert-subscription-menu (   
    ...
    valueUnit:string
    paidIn:string)
    (insert subscriptionMenu1 subscriptionId
    {
  ...
  (deftable subscriptions1:{subscription})

  (defun get-subscription-menu ()
    "Get subscription-menu"
    (select subscriptionMenu1 (constantly true))
  )
...
; create-table
; (create-table subscriptionMenu1)
