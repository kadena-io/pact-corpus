(module backalley-dev-be3de2a3-edcd-4618-b7b0-ea674a5e7406 GOVERNANCE
  ...
  (defconst POOL_ID:string "be3de2a3-edcd-4618-b7b0-ea674a5e7406"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-be3de2a3-edcd-4618-b7b0-ea674a5e7406"
  ...
  (defconst TOKEN_AMOUNT:decimal 3.200000000000
    "Amount of tokens for sale.")

  (defconst MIN_RAISE:decimal 0.000001000000
    "Mininimum raise amount necessary for a pool to be considered successful.")

  (defconst MAX_RAISE:decimal 0.000100000000
    "Maximum raise after which the pool will not accept more deposits.")

  (defconst MIN_ALLOCATION:decimal 0.000000001000
    "Minimum individual allocation.")

  (defconst MAX_ALLOCATION:decimal 0.000100000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-02-11T21:00:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-11T22:00:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T22:00:00Z")
