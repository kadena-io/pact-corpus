(module BIMBA GOVERNANCE
  ...
  (defconst INITIAL_SUPPLY:decimal 1000000000.0
    " Initial supply of 20,000,000,000 tokens. (1,000,000,000 x20 chains)")

  (defconst DECIMALS 12
    " Specifies the minimum denomination for token transactions. ")

  (defconst TOKEN_VALUE 100000.0
    " 100,000 Per 1 KDA ")
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "admin-bimba"))
