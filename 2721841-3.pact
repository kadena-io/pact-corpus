(module backalley-172a7454-7984-486b-9e1b-6b47839fc42c GOVERNANCE
  ...
  (defconst POOL_ID:string "172a7454-7984-486b-9e1b-6b47839fc42c"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-172a7454-7984-486b-9e1b-6b47839fc42c"
  ...
  (defconst START_DATE:time (time "2022-02-12T03:14:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-12T04:25:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-12T04:25:00Z")
    "The date after which tokens will start being available for redeem.")

  (defconst VESTING_SHARE:decimal 0.020000000000
