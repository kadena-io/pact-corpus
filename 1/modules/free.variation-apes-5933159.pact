(module variation-apes GOV
    "Variation Apes Mint"
  
      (defconst NFTS_TO_MINT_COUNT 1500.0)  
      (defconst WL_MINT_PRICE 8.0)
      (defconst PUBLIC_MINT_PRICE 10.0)
      (defconst WL_MINT_START_TIME "2022-10-20T19:00:00Z")
      (defconst PUBLIC_MINT_START_TIME "2022-10-21T19:00:00Z")
      (defconst MINT_END_TIME "2022-10-27T19:00:00Z")
      (defconst MAX_WL_MINT 15)
      ...
      (defconst ADMIN_KEYSET (read-keyset 'vapes-ks))
      (defconst ADMIN_ADDRESS "k:089b297cd59bc847ea09bd039dea7652d90901a59d7a61923bef3cf0c3b334ec")
      (defconst CREATOR_ADDRESS "k:f35ff98bb9620420b98bef509cc1c0dd3f5c463011834b7233e769300dd792d3")
