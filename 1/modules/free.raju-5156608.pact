(module raju GOVERNANCE

  @doc " 'raju' is one of the meme tokens launched on the Kadena Network. "
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard 'raju-admin))
