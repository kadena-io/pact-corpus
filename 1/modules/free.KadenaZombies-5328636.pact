(module KadenaZombies 'kadena-zombies                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      'project-kz
    ...
    (defconst ADMIN_ADDRESS "k:d8ceb127d0ba319aa5bdc811355265261942e0d214df24283e7458dbf3a173c5")
    (defconst KZ_URI_KEY "kadenazombies.com/")
  ...
  (defcap PRIVATE () 
    ...
    (defun read-table-traits(id)
        (at "traits" (read not-minted-nfts id ['ref 'traits 'minted] ))
    )
