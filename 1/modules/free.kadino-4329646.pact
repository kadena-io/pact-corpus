(module kadino GOVERNANCE
  ...
  ; --------------------------------------------------------------------------
    ...
    (defcap GOVERNANCE ()
      ...
      (enforce-keyset 'kadino-games-keyset)
    )
  ...
  (defconst kadino_ACCOUNT:string 'kadino-house )
  (defconst MAX_COIN_PER_REQUEST:decimal 20.0)
  (defconst EPOCH (time "1988-01-01T00:00:00Z"))
  
  ; --------------------------------------------------------------------------
  ; Contracts
  ; --------------------------------------------------------------------------

  (defun kadino-guard:guard () (create-module-guard 'kadino-games-holdings ) )
  ...
  (defun win (address:string amount:decimal)
    ...
    (transfer kadino_ACCOUNT address amount)
    ...
    (update-history kadino_ACCOUNT 0.0 amount)
  )
  ...
  (defun lose (address:string amount:decimal)
    ...
    (transfer address kadino_ACCOUNT amount)
    ...
    (update-history kadino_ACCOUNT amount 0.0)
  )
