(module kasino-games GOVERNANCE
  ...
  "'kasino-games' represents Kasino Games Contract."
  ...
  (defconst KASINO_ACCOUNT:string "k:089b297cd59bc847ea09bd039dea7652d90901a59d7a61923bef3cf0c3b334ec" )
  ...
  (defcap GOVERNANCE ()
    (enforce-guard (at 'guard (details KASINO_ACCOUNT )))
  true)
  ...
  (defun kasino-guard:guard () (create-module-guard KASINO_ACCOUNT ) )
