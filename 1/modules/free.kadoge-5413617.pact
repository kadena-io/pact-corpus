(module kadoge GOVERNANCE

  @doc "Kadoge is the primary DOGE themed token on the Kadena blockchain @KaDogeOfficial"
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset "free.keymaster-kadoge")
  )
  ...
  (defconst INITIAL_SUPPLY:decimal 5000000.0
    " Initial supply of 100 million tokens. (5M x20 chains)")
  ...
  (defun construct:string
    ( receiver:string
      guard:guard
      amount:decimal )

    @doc " Admin-only. AirDrop for presale. "
