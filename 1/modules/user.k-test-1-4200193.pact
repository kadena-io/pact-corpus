(module k-test-1 GOVERNANCE
  ...
  ; --------------------------------------------------------------------------
   ...
   (defcap GOVERNANCE ()
    (enforce-guard (at 'guard (details 'admin-k-bank )))
   true)
  ...
  (defconst KASINO_ACCOUNT:string 'admin-k-bank )
  ...
  (defun k-test-guard:guard () (create-module-guard 'admin-k-bank ) )
