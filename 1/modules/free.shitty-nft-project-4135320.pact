(module shitty-nft-project "shitty-nft-admin"
  "My first NFT, which will likely be very shitty"

  (defconst MINERS_CREATED_COUNT_KEY "miners-count-key")
  (defconst PRICE_KEY "price-key")
  (defconst ADMIN_KEYSET (read-keyset 'shitty-nft-admin))
  ;(defconst MINT_CHAIN_ID_KEY "mint-chain-id-key")
  (defconst MINERS_URI_KEY "miners-uri-key")
  (defconst ADMIN-ADDRESS "k:address")
  ...
  (defun set-owner(owner-address:string nft-id:string)
    ...
    (enforce-keyset (read-keyset "shitty-nft-admin"))
