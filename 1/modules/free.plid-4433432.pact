(module plid GOVERNANCE

@doc " $PLD smart contract for initial supply. \
  ...
  (defconst INITIAL_SUPPLY:decimal 1000000.0
    " Initial supply of 1Billion tokens. ")
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      ...
      (create-table free.plid.token-table)
    )
  )
)
