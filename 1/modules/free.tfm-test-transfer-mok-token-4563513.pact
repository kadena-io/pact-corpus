(module tfm-test-transfer-mok-token GOVERNANCE
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset 'tfm-test-transfer-mok-admin-multi-keyset)
  )
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard 'tfm-test-transfer-mok-admin-multi-keyset))
