  ...
  @doc " Grab yours algo-gen Inu Gangster cause something serious Ahusharmota is about to happen  \
    ...
    (defun create-gen-0-for-mint (attributes:list)
        ...
        (let
            ...
            (insert mint id {
                              "name": (at 0 attributes),
                              "spirit": (at 1 attributes),
                              "mindset": (at 2 attributes),
                              "intelligence": (at 3 attributes),
                              "charisma": (at 4 attributes),
                              "willpower": (at 5 attributes),
                              "strength": (at 6 attributes),
                              "minted": false
                            })
        )
    ...
    ;;;;;; INU GENGSTER NON STATE MODIFYING HELPER FUNCTIONS ;;;;;;;;;
