    ...
    (defun lock-kda
      ...
      (with-default-read last-id-table ""
        ...
        (with-default-read supply-table ""
          ...
          (enforce (<= (time "2023-04-20T17:00:00Z") (at "block-time" (chain-data))) "Locks will be enabled on April 20th 17:00 UTC") 
          (enforce (>= (time "2024-04-20T17:00:00Z") (at "block-time" (chain-data))) "Locks end on April 20th 2024 17:00 UTC") 
