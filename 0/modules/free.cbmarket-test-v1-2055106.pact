(module cbmarket-test-v1 GOVERNANCE
  ...
  (defconst COLORBLOCK_MARKET "colorblock-test-v1-market"
    "The official account of colorblock-test-v1 market"
  )
  ...
  (defun release:string
    ...
    (with-capability (RELEASE account item-id price)
      (install-capability (colorblock-test-v1.TRANSFER account COLORBLOCK_MARKET item-id))
      (colorblock-test-v1.transfer account COLORBLOCK_MARKET item-id)
  ...
  (defun modify:string
    ...
    (with-capability (MODIFY account item-id price)
      (install-capability (colorblock-test-v1.OWN-ACCOUNT account))
      (colorblock-test-v1.validate-owner account)
  ...
  (defun recall:string
    ...
    (with-capability (RECALL account item-id)
      (install-capability (colorblock-test-v1.OWN-ACCOUNT COLORBLOCK_MARKET))
  ...
  (defun purchase-with-new-user:string
    ...
    (colorblock-test-v1.create-account-maybe account guard)
