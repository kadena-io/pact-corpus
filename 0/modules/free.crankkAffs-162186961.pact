(module crankkAffs GOVERNANCE
  ...
  (defun apply-affiliate-user (affCode)
    ...
    (if (acc-not-reg-other "U")
        ""
        (enforce false "Registered for other category")
    )
  ...
  (defun apply-affiliate-infl (affCode)
    ...
    (enforce (acc-not-reg-other "I") "Registered for other category")
    (insert codes1 affCode
        {"category": "I",
         "address": (at "sender" (chain-data)),
         "affCode": affCode
  ...
  (defun apply-affiliate-comp (company)
    ...
    (enforce (acc-not-reg-other "C") "Registered for other category")
  ...
  (defun apply-affiliate-agnt (affCode company)
    ...
    (enforce (acc-not-reg-other "A") "Registered for other category")
    (insert codes1 affCode
        {"category": "A",
         "address": (at "sender" (chain-data)),
         "affCode": affCode
