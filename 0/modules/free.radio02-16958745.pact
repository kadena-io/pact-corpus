(module radio02 GOVERNANCE
  ...
  (defun get-nodeExtra ()
    "Get all nodeExtras"
    (select nodeExtra7 (constantly true))
  )

  (defun update-node-extra (address online hosted oracle factor)
    (with-default-read nodeExtra7 address 
