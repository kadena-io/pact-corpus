          ...
          ( lambda 
            ...
            (if
              ...
              (let
                ...
                (with-capability (REWARDED (at 'uid record) (at 'begin_date record) (at 'end_date record) (at 'amount record))
                  (install-capability (coin.TRANSFER KEDAO_REWARDS_POOL (at 'account user) (at 'amount record)))
                  (coin.transfer KEDAO_REWARDS_POOL (at 'account user) (at 'amount record))
                  (insert reward-records (format "{}_{}_{}" [(at 'uid record), (at 'begin_date record), (at 'end_date record)])
                    record
                  )
                )
              )
