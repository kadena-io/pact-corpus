(module kda-skellies GOV
    "Kadena Skellies Mint"
      ...
      (defconst MINT_END_TIME "2022-11-06T20:00:00Z")
      ...
      (defun enforce-marketplace-live ()
          ...
          (enforce (or (>= (at "block-time" (chain-data)) (time MINT_END_TIME)) (= (get-count NFTS_MINTED_COUNT_KEY) NFTS_TO_MINT_COUNT)) "Mint is not live.")
      )
