(module monster-dollar GOVERNANCE

  @doc " 'Monster' is a new implemented token on the Kadena mainnet  \
       \ Adapted from anedak contract  "
  ...
  (defconst INITIAL_SUPPLY:decimal 1650000000.0
    " Initial supply of 33 million tokens. (1,650,000 x20 chains)")
