(module backalley-e2448541-7114-4ebd-bf5d-ff9145102119 GOVERNANCE
  ...
  (defconst POOL_ID:string "e2448541-7114-4ebd-bf5d-ff9145102119"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-e2448541-7114-4ebd-bf5d-ff9145102119"
  ...
  (defconst OWNER:string "k:d75fdc68a1b5c82fabfb417ca61ed415c40c0898700d29a051cb7d0be6f6bf0c"
    "Account that initiated this pool")

  (defconst TOKEN_AMOUNT:decimal 10.000000000000
    "Amount of tokens for sale.")

  (defconst MIN_RAISE:decimal 0.000000100000
    "Mininimum raise amount necessary for a pool to be considered successful.")

  (defconst MAX_RAISE:decimal 0.000010000000
    "Maximum raise after which the pool will not accept more deposits.")

  (defconst MIN_ALLOCATION:decimal 0.000000100000
    "Minimum individual allocation.")

  (defconst MAX_ALLOCATION:decimal 0.000010000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-02-12T03:45:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-12T03:59:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-12T03:59:00Z")
    "The date after which tokens will start being available for redeem.")

  (defconst VESTING_SHARE:decimal 0.000100000000
