(module mintit-policy-staging-v6 GOVERNANCE
  ...
  (defun sync-with-marmalade:bool
    ...
    (let*
      (
        ...
        (datum-uri (kip.token-manifest.uri "pact:schema" "free.mintit-policy-staging-v6.nft-manifest-datum"))
    ...
    (marmalade.ledger.create-token token-id token-precision nft-manifest mintit-policy-staging-v6)
