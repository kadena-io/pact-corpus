(module backalley-ee2fefe1-46fe-47a5-bf1e-e9481c2a5acd GOVERNANCE
  ...
  (defconst POOL_ID:string "ee2fefe1-46fe-47a5-bf1e-e9481c2a5acd"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-ee2fefe1-46fe-47a5-bf1e-e9481c2a5acd"
  ...
  (defconst START_DATE:time (time "2022-01-26T04:05:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-26T04:10:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-26T04:12:00Z")
