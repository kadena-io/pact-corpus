(module kapepe-nft-test GOVERNANCE
  ...
  (defun enforce-orchestrator:bool ()
     (enforce-guard "n_5a7ccd559b245b7dcbd5259e1ee43d04fbf93eab.kapepe-admin-keyset")
   )
  ...
  (defun mint(owner:string guard:guard created-tokenList:list token-id:string)
    (require-capability (MINT token-id owner))
...
; (create-table nfts)
; (mint-bulk 1
;   "k:1604706e7486b5abc1c5391a2f83c3d636a4668eb08572a0777286323a2e4c48"
;   (read-keyset "kapepe-admin-keyset"))

; (marmalade.ledger.mint "kapepe-nft-gen-1-test99" "k:b8b74b220522884b7b02481a823034a2dc03b170f8931f4e7b90940472188ad2" (read-keyset "kapepe-admin-keyset") 1.0)
