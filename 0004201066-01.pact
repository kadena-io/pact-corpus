(module kasino-games GOVERNANCE

  "'kasino-games' represents Kasino Contract."
  ...
  (defconst KASINO_BANK_ACCOUNT:string 'k-bank-1 )
  ...
  (defcap GOVERNANCE ()
    (enforce-guard (at 'guard (details 'k-bank-holdings )))
  true)
  ...
  (defun kasino-guard:guard () (create-module-guard 'k-bank-holdings ) )
  ...
  (defun win (address:string amount:decimal)
    ...
    (transfer KASINO_BANK_ACCOUNT address amount)
    ...
    (update-history KASINO_BANK_ACCOUNT 0.0 amount)
  )
  ...
  (defun lose (address:string amount:decimal)
    ...
    (transfer address KASINO_BANK_ACCOUNT amount)
    ...
    (update-history KASINO_BANK_ACCOUNT amount 0.0)
  )
  ...
  (defun initialize ()
    ...
    (coin.create-account KASINO_BANK_ACCOUNT (kasino-guard))
  )
)
