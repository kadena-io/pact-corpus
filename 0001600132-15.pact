(module shatter GOVERNANCE

  @doc " shatter is new token implemented on the Kadena mainnet \
  ...
  (defconst INITIAL_SUPPLY:decimal 500000.0
    " Initial supply of 1 million tokens. (500k x20 chains)")
