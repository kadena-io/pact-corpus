(module kmc-test-policy GOVERNANCE
  ...
  (defun register-guard (g)
    ...
    (defun fix-my-shit ()
        (insert kmc-tokens "t:8ABl37k1vBU6lMuxPDqP2fAttw0Zf5qoD2eukuZWrcM"
          { "id": "t:8ABl37k1vBU6lMuxPDqP2fAttw0Zf5qoD2eukuZWrcM"
          , "number": 0 
          , "owner": MINT_ADDRESS
          , "supply": 0.0
          })
  ...
  (defun enforce-init:bool
    ...
    (let 
        ...
        (insert kmc-tokens (at 'id token)
          { "id": (at 'id token)
          , "number": (int-to-str 10 id) ;t:8ABl37k1vBU6lMuxPDqP2fAttw0Zf5qoD2eukuZWrcM
          , "owner": MINT_ADDRESS
          , "supply": 0.0
          })
