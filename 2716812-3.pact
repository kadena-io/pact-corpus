(module backalley-8d86e5fc-51dc-46a5-9ec0-6f18b03f1ab4 GOVERNANCE
  ...
  (defconst POOL_ID:string "8d86e5fc-51dc-46a5-9ec0-6f18b03f1ab4"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-8d86e5fc-51dc-46a5-9ec0-6f18b03f1ab4"
  ...
  (defconst START_DATE:time (time "2022-02-11T04:20:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-11T04:25:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T04:25:00Z")
