(module kda-skellies-testnet GOV
    ...
    (defconst WL_MINT_START_TIME "2023-10-27T00:00:00Z")
    (defconst PUBLIC_MINT_START_TIME "2023-10-27T01:00:00Z")
    (defconst MINT_END_TIME "2023-12-01T00:00:00Z")
    ...
    (defconst OFFERS_BANK:string "kda-skellies-testnet-offers-bank")
    (defconst STAKING_BANK:string "kda-skellies-testnet-staking-bank")
    ...
    (defconst IS_STAKING_LIVE true)
	(defconst STAKING_END_TIME "2023-11-13T22:30:00Z")
    ...
    (defun calculate-reward (stakedTime:time)
        ;enforce(enforce-staking-live)
        (enforce (>= (at "block-time" (chain-data)) (time STAKING_END_TIME)) ceiling (* (/ (diff-time (at "block-time" (chain-data)) (time STAKING_END_TIME)) 86400) 0.02) 6)
        (enforce (<= (at "block-time" (chain-data)) (time STAKING_END_TIME)) ceiling (* (/ (diff-time (at "block-time" (chain-data)) (time stakedTime)) 86400) 0.02) 6)
    )	
