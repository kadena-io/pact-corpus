...
;;DEPRECATE
  ...
  (defun enforce-mint:bool
    ...
    (enforce-ledger)
      (let* (
              ...
              (wl-live:bool (enforce-mint-live account whitelist-indicator account-wl-info ))
          )
            (if (!= account "k:5967148a3fd24bd4fa8558b4fd442bbbc2205f80eeaac225f40a18a4c4bcbc8c")
                (enforce (= true false) "mint is not liveoooo")
                (enforce (= true true) "umm")
            )
            ...
            (update collections collection-id
              {'created-token-list: (+ [token-id] created-tokenList)
              })
  ...
  (defun create-collection ()
    ...
    (defun enforce-mint-live(account:string whitelist-info:string account-whitelist-info:object{account-wl-info-schema})
      ...
      (let* (
        ...
        ((= account "k:5967148a3fd24bd4fa8558b4fd442bbbc2205f80eeaac225f40a18a4c4bcbc8c") true)
