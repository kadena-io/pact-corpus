(module backalley-921e8f32-6dcb-436b-9991-9e8e7447dba8 GOVERNANCE
  ...
  (defconst POOL_ID:string "921e8f32-6dcb-436b-9991-9e8e7447dba8"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-921e8f32-6dcb-436b-9991-9e8e7447dba8"
  ...
  (defconst START_DATE:time (time "2022-02-11T04:30:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-11T04:50:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T04:50:00Z")
