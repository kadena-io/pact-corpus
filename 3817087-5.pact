    ...
    (map
      (lambda
        ...
        (let*
          ...
          (+ pixel {"price-hundredths-str":(int-to-str 10 (^ 2 (at "times-bought" pixel)))})
        )
      )
      pixel-id-strs
    )
  ...
  (defun get-place:[object] ()
    ...
    (fold
      (lambda
        ...
        (+ acc [{"id":pixel-id-str,"color":(at "color" (read pixel-table-1 pixel-id-str))}])
      )
      []
      (keys pixel-table-1)
    )
  ...
  (defun get-place-history:[object] ()
    ...
    (fold
      (lambda
        ...
        (let*
          (
            (pixel (try {"times-bought":0} (read pixel-table-1 pixel-id-str)))
            (times-bought (at "times-bought" pixel))
          )
          (+ acc [{"id":pixel-id-str,"history":(if (= 0 times-bought)
            []
            (fold
              (lambda
                (
                ...
                (+ acc [(read pixel-buy-table (+ pixel-id-str (+ "-" (int-to-str 10 times-bought))))])
              )
              []
