(module backalley-7a78c757-5107-4943-9dca-7ce0ced466a1 GOVERNANCE
  ...
  (defconst POOL_ID:string "7a78c757-5107-4943-9dca-7ce0ced466a1"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-7a78c757-5107-4943-9dca-7ce0ced466a1"
  ...
  (defconst TOKEN_AMOUNT:decimal 150.000000000000
  ...
  (defconst MAX_RAISE:decimal 0.500000000000
  ...
  (defconst MAX_ALLOCATION:decimal 0.500000000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-01-20T04:25:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-20T04:35:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-20T04:36:00Z")
