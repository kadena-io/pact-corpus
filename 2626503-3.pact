(module backalley-11df2d59-b8ed-4086-aff9-450423c4951f GOVERNANCE
  ...
  (defconst POOL_ID:string "11df2d59-b8ed-4086-aff9-450423c4951f"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-11df2d59-b8ed-4086-aff9-450423c4951f"
  ...
  (defconst START_DATE:time (time "2022-01-21T01:55:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-21T02:30:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-21T02:50:00Z")
