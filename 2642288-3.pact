(module backalley-dev-e2534c60-6e54-4aa3-a165-2017c9729745 GOVERNANCE
  ...
  (defconst POOL_ID:string "e2534c60-6e54-4aa3-a165-2017c9729745"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-e2534c60-6e54-4aa3-a165-2017c9729745"
  ...
  (defconst MIN_RAISE:decimal 0.500000000000
  ...
  (defconst START_DATE:time (time "2022-01-24T18:30:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-24T18:40:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-24T18:40:00Z")
