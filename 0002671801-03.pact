(module backalley-614b574f-829c-408a-b962-d105dad75372 GOVERNANCE
  ...
  (defconst POOL_ID:string "614b574f-829c-408a-b962-d105dad75372"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-614b574f-829c-408a-b962-d105dad75372"
  ...
  (defconst MAX_RAISE:decimal 0.001000000000
  ...
  (defconst START_DATE:time (time "2022-02-01T00:10:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-01T00:40:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-01T00:40:00Z")
    "The date after which tokens will start being available for redeem.")

  (defconst VESTING_SHARE:decimal 0.100000000000
