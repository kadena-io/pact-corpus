(module backalley-cb0d32d3-6ba2-4b37-b659-1e218cc799c3 GOVERNANCE
  ...
  (defconst POOL_ID:string "cb0d32d3-6ba2-4b37-b659-1e218cc799c3"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-cb0d32d3-6ba2-4b37-b659-1e218cc799c3"
  ...
  (defconst START_DATE:time (time "2022-02-01T05:20:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-01T05:55:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-01T05:55:00Z")
