(module backalley-8b22e425-35b2-4309-afa4-365dcf9e5f2e GOVERNANCE
  ...
  (defconst POOL_ID:string "8b22e425-35b2-4309-afa4-365dcf9e5f2e"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-8b22e425-35b2-4309-afa4-365dcf9e5f2e"
  ...
  (defconst TOKEN_AMOUNT:decimal 5.000000000000
  ...
  (defconst START_DATE:time (time "2022-01-21T23:25:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-23T23:25:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-23T23:25:00Z")
