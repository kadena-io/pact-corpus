(module backalley-64f3f767-813f-461a-8144-ab784675b1be GOVERNANCE
  ...
  (defconst POOL_ID:string "64f3f767-813f-461a-8144-ab784675b1be"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-64f3f767-813f-461a-8144-ab784675b1be"
  ...
  (defconst TOKEN_AMOUNT:decimal 15.000000000000
  ...
  (defconst START_DATE:time (time "2022-02-01T01:50:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-01T02:50:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-01T02:50:00Z")
    "The date after which tokens will start being available for redeem.")

  (defconst VESTING_SHARE:decimal 0.050000000000
    "Percentage of tokens available for redeem after each vesting period.")

  (defconst VESTING_PERIOD_IN_SECS:integer 7862400
