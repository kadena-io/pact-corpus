(module backalley-dev-bb0aed85-567b-4017-bc2d-9eb469ee067e GOVERNANCE
  ...
  (defconst POOL_ID:string "bb0aed85-567b-4017-bc2d-9eb469ee067e"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-bb0aed85-567b-4017-bc2d-9eb469ee067e"
  ...
  (defconst TOKEN_AMOUNT:decimal 100.000000000000
  ...
  (defconst MIN_ALLOCATION:decimal 0.100000000000
    "Minimum individual allocation.")

  (defconst MAX_ALLOCATION:decimal 1.000000000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-12-20T00:00:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-12-21T00:00:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-12-23T00:00:00Z")
