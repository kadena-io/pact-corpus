(module backalley-6051462c-1522-431f-8a14-67da7beb07a4 GOVERNANCE
  ...
  (defconst POOL_ID:string "6051462c-1522-431f-8a14-67da7beb07a4"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-6051462c-1522-431f-8a14-67da7beb07a4"
  ...
  (defconst TOKEN_AMOUNT:decimal 2.000000000000
  ...
  (defconst START_DATE:time (time "2022-01-22T00:35:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-22T00:45:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-22T00:45:00Z")
