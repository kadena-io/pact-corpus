(module backalley-dev-4b751ecc-33bc-4797-bb3a-35aaecf0df69 GOVERNANCE
  ...
  (defconst POOL_ID:string "4b751ecc-33bc-4797-bb3a-35aaecf0df69"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-4b751ecc-33bc-4797-bb3a-35aaecf0df69"
  ...
  (defconst TOKEN_AMOUNT:decimal 2.500000000000
    "Amount of tokens for sale.")

  (defconst MIN_RAISE:decimal 0.100000000000
    "Mininimum raise amount necessary for a pool to be considered successful.")

  (defconst MAX_RAISE:decimal 1.250000000000
    "Maximum raise after which the pool will not accept more deposits.")

  (defconst MIN_ALLOCATION:decimal 0.000000010000
    "Minimum individual allocation.")

  (defconst MAX_ALLOCATION:decimal 1.250000000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-02-11T19:45:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-11T19:55:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T19:55:00Z")
