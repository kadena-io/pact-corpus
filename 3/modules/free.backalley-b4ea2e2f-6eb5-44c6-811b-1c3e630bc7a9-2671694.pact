(module backalley-b4ea2e2f-6eb5-44c6-811b-1c3e630bc7a9 GOVERNANCE
  ...
  (defconst POOL_ID:string "b4ea2e2f-6eb5-44c6-811b-1c3e630bc7a9"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-b4ea2e2f-6eb5-44c6-811b-1c3e630bc7a9"
  ...
  (defconst TOKEN_AMOUNT:decimal 50.000000000000
  ...
  (defconst START_DATE:time (time "2022-01-31T23:30:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-31T23:40:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-31T23:45:00Z")
    "The date after which tokens will start being available for redeem.")

  (defconst VESTING_SHARE:decimal 0.200000000000
