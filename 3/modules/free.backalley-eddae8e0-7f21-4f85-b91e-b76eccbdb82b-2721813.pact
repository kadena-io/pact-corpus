(module backalley-eddae8e0-7f21-4f85-b91e-b76eccbdb82b GOVERNANCE
  ...
  (defconst POOL_ID:string "eddae8e0-7f21-4f85-b91e-b76eccbdb82b"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-eddae8e0-7f21-4f85-b91e-b76eccbdb82b"
  ...
  (defconst TOKEN_AMOUNT:decimal 1.250000000000
    "Amount of tokens for sale.")

  (defconst MIN_RAISE:decimal 5.000000000000
    "Mininimum raise amount necessary for a pool to be considered successful.")

  (defconst MAX_RAISE:decimal 10.000000000000
  ...
  (defconst MAX_ALLOCATION:decimal 10.000000000000
