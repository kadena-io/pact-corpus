(module backalley-dev-7d43a3b4-465e-4bdd-9fc5-37be8b995644 GOVERNANCE
  ...
  (defconst POOL_ID:string "7d43a3b4-465e-4bdd-9fc5-37be8b995644"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-7d43a3b4-465e-4bdd-9fc5-37be8b995644"
  ...
  (defconst START_DATE:time (time "2022-01-21T02:30:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-25T02:30:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-25T02:30:00Z")
