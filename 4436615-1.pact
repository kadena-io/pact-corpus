(module gezer GOVERNANCE

  @doc " 'gzr' is the first token implemented on the Kadena mainnet \
  ...
  (defcap GOVERNANCE
    ...
    @doc " Give the admin full access to call agnd upgrade the module. "

    (enforce-keyset 'admin-gezer)
  )
