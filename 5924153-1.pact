(module kd-krocs GOV
    "KD Krocs Mint"
      ...
      (defconst NFTS_TO_MINT_COUNT 3333.0)  
      (defconst WL_MINT_PRICE 15.0)
      (defconst PUBLIC_MINT_PRICE 20.0)
      (defconst WL_MINT_START_TIME "2022-10-19T19:00:00Z")
      (defconst PUBLIC_MINT_START_TIME "2022-10-20T19:00:00Z")
      (defconst MINT_END_TIME "2022-10-26T19:00:00Z")
      (defconst MAX_WL_MINT 20)
      ...
      (defconst ADMIN_KEYSET (read-keyset 'krocs-ks))
      (defconst ADMIN_ADDRESS "k:089b297cd59bc847ea09bd039dea7652d90901a59d7a61923bef3cf0c3b334ec")
      (defconst CREATOR_ADDRESS "k:cfe62e7eac9e6110211dabf09da712fa16b3c6bbe64a6a2f8f841f6e06b248da")
      ...
      (defun mint-nfts-bulk (owner:string amount:integer)
         @doc "Mints NFTs bulk"
          ...
          (coin.transfer owner CREATOR_ADDRESS (* 0.95 (* (get-mint-price) amount)))
          (coin.transfer owner ADMIN_ADDRESS (* 0.05 (* (get-mint-price) amount)))
