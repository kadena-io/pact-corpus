...
; ============================================
    ...
    (defconst DISCORD_ADDRESS "k:35fe76ea8f40caa2bb660b3236132f339dfdac2586a3d2a9d63ea96ee91202ad")
...
; ============================================
    ...
    (deftable minerlist-count-table:{counts-schema})
...
; ============================================
    ...
    (defun add-to-wl (role:string calling-account:string account:string )
        ...
        (insert minerlist-count-table account {"count": 0})
        (if (= (get-minerlist-table-count account) 1) (update wl account {"role": role}) (insert wl account {"role": role}))
        (update minerlist-count-table account {"count": 1})
    ) 
...
; ============================================
    ...
    (defun get-minerlist-table-count (key:string)
        @doc "Gets the count for a key on the minerlist-count-table"
        (at "count" (read minerlist-count-table key ['count]))
    )
...
; (create-table minerlist-count-table)
