(module hyperhub GOVERNANCE

  @doc " 'Hyperhub ' is a token implemented on the Kadena mainnet \
  ...
  (defconst INITIAL_SUPPLY:decimal 88000000.0
    " Initial supply of 88 million tokens. (88000000x1 chain)")
