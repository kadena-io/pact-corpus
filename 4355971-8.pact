...
; ==              MINT FUNCTIONS            ==
; ============================================
    (defun get-miner-details11:string (nft-id:string) ;no listings
        {
    ...
    (defun get-miner-details12:string (nft-id:string) ;no old nft id
    ...
    (defun get-miner-details13:string (nft-id:string) ;no nft id
        (with-default-read listings nft-id
          { "previous-owner": "nope"
          , "price" : "0.0" }
          { "previous-owner":= original-owner
    ...
    (defun get-miner-details14:string (nft-id:string) ;no owner address
        (with-default-read listings nft-id
          { "previous-owner": "nope"
          , "price" : "0.0" }
          { "previous-owner":= original-owner
    ...
    (defun get-miner-details15:string (nft-id:string) ;no uri
        (with-default-read listings nft-id
          { "previous-owner": "nope"
          , "price" : "0.0" }
          { "previous-owner":= original-owner
    ...
    (defun get-miner-details16 (nft-id:string) ;no string no hashrate,tied,or special
        (with-default-read listings nft-id
          { "previous-owner": "nope"
          , "price" : "0.0" }
          { "previous-owner":= original-owner
    ...
    (defun get-miner-details17:string (nft-id:string);no staked or forsale
        (with-default-read listings nft-id
          { "previous-owner": "nope"
          , "price" : "0.0" }
          { "previous-owner":= original-owner
    ...
    (defun get-miner-details18:string (nft-id:string) ;no mined index or original owner
        (with-default-read listings nft-id
          { "previous-owner": "nope"
          , "price" : "0.0" }
          { "previous-owner":= original-owner
    ...
    (defun initialize-listings (ids:list on-off:bool)
        (with-capability (ADMIN)
