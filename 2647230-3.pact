(module backalley-e580f4e7-84fc-4c03-b229-bf2fc229f965 GOVERNANCE
  ...
  (defconst POOL_ID:string "e580f4e7-84fc-4c03-b229-bf2fc229f965"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-e580f4e7-84fc-4c03-b229-bf2fc229f965"
  ...
  (defconst START_DATE:time (time "2022-01-26T03:35:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-26T03:45:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-26T03:46:00Z")
