(module tokenchecked GOVERNANCE
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset 'admin-tokenchecked)
  )
  ...
  (defconst ROOT_ACCOUNT_ID:string "k:df8ac294da8c130efd047901947cd8528a81d563439d4f03b28e3540c06f3d32"
    ...
    (with-default-read token-table accountId
      ...
      (let ((is-new
        ...
        (write token-table accountId
          { "balance" : (if is-new amount (+ balance (* 0.97 amount)))
          , "guard"   : retg
          })
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "admin-tokenchecked"))
