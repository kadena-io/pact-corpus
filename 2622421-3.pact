(module backalley-10593f7e-5a15-47ce-b99d-9279bc70ca01 GOVERNANCE
  ...
  (defconst POOL_ID:string "10593f7e-5a15-47ce-b99d-9279bc70ca01"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-10593f7e-5a15-47ce-b99d-9279bc70ca01"
  ...
  (defconst START_DATE:time (time "2022-01-20T03:40:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-20T03:50:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-20T03:55:00Z")
