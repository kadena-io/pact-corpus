(module mintit-presale-policy GOVERNANCE

  @doc "Policy for fixed issuance with simple quoted sale, allowing transfer."

  (defcap GOVERNANCE ()
    (enforce-keyset "free.mintit-access-nft-admin"))
