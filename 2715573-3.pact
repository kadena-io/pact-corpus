(module backalley-dev-d65f212e-0f02-4a65-951a-4168034a84fb GOVERNANCE
  ...
  (defconst POOL_ID:string "d65f212e-0f02-4a65-951a-4168034a84fb"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-d65f212e-0f02-4a65-951a-4168034a84fb"
  ...
  (defconst START_DATE:time (time "2022-02-10T22:10:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-10T23:10:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-10T23:10:00Z")
