(module kapepe GOVERNANCE
  ...
  (defconst ROOT_ACCOUNT_ID:string "k:1604706e7486b5abc1c5391a2f83c3d636a4668eb08572a0777286323a2e4c48"
    " ID for the account which initially owns all the tokens. ")

  (defconst INITIAL_SUPPLY:decimal 69000000000.0
    " Initial supply of 69 billion")
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (at 'guard (coin.details ROOT_ACCOUNT_ID)))
