(module tron GOVERNANCE

  @doc " Tron is a new token implemented on the Kadena mainnet \
  ...
  (defconst INITIAL_SUPPLY:decimal 1000000.0
    " Initial supply of 1,000,000 tokens. (50,000 token x20 chains)")
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "admin-tron"))
