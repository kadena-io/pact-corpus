(module backalley-72107d38-87c8-4076-b617-5537010192df GOVERNANCE
  ...
  (defconst POOL_ID:string "72107d38-87c8-4076-b617-5537010192df"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-72107d38-87c8-4076-b617-5537010192df"
  ...
  (defconst OWNER:string "k:d7924a8b0ab843d086381a169adba846165aa23f0ed053a40ed4d39121b7b2fa"
    "Account that initiated this pool")

  (defconst TOKEN_AMOUNT:decimal 1000.000000000000
  ...
  (defconst MAX_RAISE:decimal 0.002000000000
    "Maximum raise after which the pool will not accept more deposits.")

  (defconst MIN_ALLOCATION:decimal 0.001000000000
    "Minimum individual allocation.")

  (defconst MAX_ALLOCATION:decimal 0.002000000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-01-26T23:58:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-27T00:02:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-27T00:03:00Z")
