(module tfm-mok-vesting 'mfk-hype-admin-multi-keyset
  ...
  (defconst MOK_BANK:string 'mok-bank)
  ;(defun mok-bank-guard () (keyset-ref-guard "mfk-hype-admin-multi-keyset" ))

  (defconst MOK_HYPE_ESCROW:string 'mok-hype-escrow)
  (defun mok-hype-escrow-guard () (keyset-ref-guard "mfk-hype-admin-multi-keyset" ))
