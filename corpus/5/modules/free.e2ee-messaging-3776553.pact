(module e2ee-messaging GOV
	...
	(defun create-message (your-account:string their-account:string content:[object])
		(try (create-conversation your-account their-account) (read conversation-table-1 (conversation-id your-account their-account)))
		(let*
			(
...
;(create-table conversation-table-1)
;(create-table message-table-1)
