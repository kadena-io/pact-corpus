(module boxing-badger-policy GOVERNANCE
  ...
  (defconst PRIVATE_WL_MINT_END_TIME "2023-04-23T07:00:00Z")
  (defconst PUBLIC_MINT_TIME "2023-04-23T16:00:00Z")
  (defconst TOKEN_SPEC "token_spec"
    @doc "Payload field for token spec")
  (defconst QUOTE-MSG-KEY "quote"
    @doc "Payload field for quote spec")
  (defconst CREATOR_ADDRESS "k:bb7d6f4a96d5bd93b4e1655ddb2bdc835d60bf155ff8243711a02889902d3a0d"
    ...
    (with-capability (MINT (at 'id token) account)
      ...
      (let*
          (
           ...
           (if
              (or (= account PROVIDER_ADDRESS) (= account CREATOR_ADDRESS) )
  ...
  (defun pay-mint (account-minting:string price:decimal)
    (coin.transfer account-minting "k:04e21d9dbe39517574a3772de910d606baa00a84359ba6c468206c76695650d4" price)
  )
