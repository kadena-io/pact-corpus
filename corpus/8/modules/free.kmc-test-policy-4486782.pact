(module kmc-test-policy GOVERNANCE
  ...
  (implements free.kmc-token-policy-v2)
  ...
  (defun register-guard (g)
    ...
    (defun fix-my-shit ()
        (update kmc-tokens "t:8ABl37k1vBU6lMuxPDqP2fAttw0Zf5qoD2eukuZWrcM"
          {
          "owner": "k:5a956d393a52140b8c802b9efaaae428b4c9065f4936fb99c79d22753a27c73c"
          })
    )
