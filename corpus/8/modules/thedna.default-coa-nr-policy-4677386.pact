(module default-coa-nr-policy GOVERNANCE

  @doc "Policy for fixed issuance, no royalty, and quoted sale in specified fungible. Allows burn and transfer."

  (defcap GOVERNANCE ()
    (enforce-guard (keyset-ref-guard 'thedna-default-coa-nr-policy-ks-C48C4A775C9A )))
  ...
  (defun enforce-init:bool
    ...
    (enforce-ledger)
    ;; Only admin can init
    (enforce-keyset 'thedna-only-admin-init-ks-C48C4A775C9A)
