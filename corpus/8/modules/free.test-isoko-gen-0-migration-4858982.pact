(module test-isoko-gen-0-migration GOVERNANCE
  @doc "Policy for Gen0 NFTs"
  ...
  (defconst AIRDROP_ADDRESS "k:dc935ba924a76d5d118b6000b9dcefee7a436dd7a45f744c1bb4d497d97281fc"
    @doc "provider address which operates airdrops")
  ...
  (defconst MAX-UNIQUE-SUPPLY 696969696969696969696969
    @doc "Max unique supply Todo check gen0 supply")
  ...
  (defschema account-wl-record-schema
    @doc "Schema to hold account information"
    account:string
        ...
        (with-capability (MINT (at 'id token) account)
          ...
          (let*
              (
               ...
               (update-wl-info account account-wl-info)
  ...
  (defun update-wl-info (account:string wl-info:object{account-wl-record-schema})
