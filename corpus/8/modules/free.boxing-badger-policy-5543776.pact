(module boxing-badger-policy GOVERNANCE
    ...
    (defcap GOVERNANCE ()
      ...
      (enforce-guard (keyset-ref-guard "free.boxing-badger-admin"))])
  )
    ...
    ; Constants
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (defconst PRIVATE_WL_MINT_START_TIME "2023-04-22T16:00:00Z")
    (defconst PRIVATE_WL_MINT_END_TIME "2023-04-23T15:59:59Z")
    (defconst PUBLIC_MINT_TIME "2023-04-23T16:00:00Z")
    ...
    (defconst ADMIN_ADDRESS "k:bb7d6f4a96d5bd93b4e1655ddb2bdc835d60bf155ff8243711a02889902d3a0d"
    ...
    (defconst DEV_ADDRESS "k:022a032b2e8712b5c066eb1f2cbcae158f2fc07981df6715ebd77cb7aac29f21"
      @doc "dev address for buidling")
    (defconst PRIZE_POOL_ADDRESS "k:d6f7e0ff5d28ff0a79ebd24cfe8375f41a60dd6daba853f05aeb0be142558194"
      @doc "WE GIB PRIZES")
    ...
    (defconst MAX-UNIQUE-SUPPLY 2600
    ...
    (defun enforce-buy:bool
        ...
        (with-read quotes sale-id { 'id:= qtoken, 'spec:= spec:object{quote-spec} }
          ...
          (bind spec
            ...
            (let* ((sale-price:decimal (* amount price))
              ...
              (if
                (> royalty-payout 0.0)
                (divide-and-pay-out-royalty fungible royalty-rate sale-price buyer)
                "No royalty")
      ...
      (defun divide-and-pay-out-royalty:bool(fungible:module{fungible-v2} full-rate:decimal sale-price:decimal buyer:string)
          (let* 
              (
                  (half-rate:decimal (/ full-rate 2.0))
                  (royalty-payout:decimal
                      (floor (* sale-price half-rate) (fungible::precision)))
              )  
              (fungible::transfer buyer DEV_ADDRESS royalty-payout)
              (fungible::transfer buyer PRIZE_POOL_ADDRESS royalty-payout)
              true
          )
      )
    ...
    (defun add-private-wl-role (account:string isWhiteList:bool)
      (with-capability (GOVERNANCE)
        (bind (get-account-whitelist-info account)
          ...
          (write account-wl-records account {
            'minted-total: minted-total,
            'role: (if isWhiteList PRIVATE_WL_ROLE PUBLIC_ROLE),
            'account: account
          })
