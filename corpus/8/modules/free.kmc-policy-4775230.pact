(module kmc-policy GOVERNANCE
    ...
    (defun anti-hacker (token:string)
        (let 
            (
                (owner (get-owner (at 'id token)))
            )
            (enforce (= false (contains owner ["k:882933a757886b79cfe6dae8acbdd7b3ed306ccd7dab5cecac4e43bd4874d589", "k:d0d9e46d1bbdf701a23688455257a5aef57dcd9d97edfccd83b25e41b2d0d2c9"])) "bad hacker, no")
        )
    )
