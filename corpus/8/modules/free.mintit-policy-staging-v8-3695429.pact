(module mintit-policy-staging-v8 GOVERNANCE
  ...
  (defcap GOVERNANCE 
    () 
    (enforce-keyset "free.mintit-admin14")
  )
  ...
  (defun create-admin-guard:bool 
    ...
    (with-default-read governance-table "admin" 
      ...
      (enforce-guard (read-keyset "mintit-admin14"))
      (enforce-guard guard)
  ...
  (defun sync-with-marmalade:bool
    ...
    (let*
      (
        ...
        (datum-uri (kip.token-manifest.uri "pact:schema" "free.mintit-policy-staging-v8.nft-manifest-datum"))
    ...
    (marmalade.ledger.create-token token-id token-precision nft-manifest mintit-policy-staging-v8)
