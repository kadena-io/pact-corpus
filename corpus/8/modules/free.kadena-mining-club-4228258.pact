        ...
        (with-read collection-offer-table offer-id
            ...
            (with-capability (PRIVATE)
                (let (
                    ...
                    (with-capability (BANK_DEBIT)
                        (royalty-payouts COLLECTION_OFFER_ACCOUNT owner amount)
                    )
                    (if (= for-sale false)
...
; ============================================
    ...
    (defun get-airdrop-details-default (account:string)
        (with-default-read airdrop-table account
            { "airdrop": [] }
            { "airdrop":= airdrop }
            airdrop
        )
    ...
    (defun combine-lists (account:string)
        ...
        (let 
            (
                (airdrop (get-airdrop-details-default account))
