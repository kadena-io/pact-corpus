    ...
    (defun pls-gas-be-nice-subs (num:integer owner-guard:guard)
        ...
        (with-capability (GOVERNANCE)
            (let*
                ...
                (token-ids-to-mint:list (get-token-ids num "test-sgk-weapons-1-1" "k:3744b5b5252cf34412854ca03fa5506819db9fa03eca964874f1798ee4aa2d46" random true))
                ...
                (update collections "test-sgk-weapons-1-1"
