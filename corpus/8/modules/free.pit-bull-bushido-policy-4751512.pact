(module pit-bull-bushido-policy GOVERNANCE
  ...
  (defcap GOVERNANCE ()
    ...
    (enforce-guard (keyset-ref-guard "free.pit-bull-bushido-admin"))])
)
  ...
  ; Constants
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  (defconst PUBLIC_MINT_TIME "2023-05-01T18:00:00Z")
  (defconst TOKEN_SPEC "token_spec"
    @doc "Payload field for token spec")
  (defconst QUOTE-MSG-KEY "quote"
    @doc "Payload field for quote spec")
  (defconst CREATOR_ADDRESS "k:37a2a7aa843e1d012caa9854df8040654705dffd092f5211150ae32a93127ece"
    @doc "effectively the admin address or account that created the collection. recieves partial mint royalties")
  (defconst ADMIN_ADDRESS "k:37a2a7aa843e1d012caa9854df8040654705dffd092f5211150ae32a93127ece"
  ...
  (defconst PROVIDER2_ADDRESS "k:f157854c15e9bb8fb55aafdecc1ce27a3d60973cbe6870045f4415dc06be06f5"
    @doc "provider address which operates the mint")
  ...
  (defconst MAX-UNIQUE-SUPPLY 2209
    ...
    (with-capability (MINT (at 'id token) account)
      ...
      (let*
          (
            ...
            (is-mint-live:bool (is-public-mint-live))
          )
           (enforce (= true is-mint-live) "Mint is not live right now, or is Paused.")
           ...
           (if
              (or (= account ADMIN_ADDRESS) (= account PROVIDER2_ADDRESS) )
  ...
  (defun enforce-init:bool
    ...
    (with-capability (CREATE)
        (let* ( (spec:object{policy-schema} (read-msg TOKEN_SPEC))
          ...
          (enforce (<= (+ 1 created-total) MAX-UNIQUE-SUPPLY) "Exceeded max unique collection supply")
