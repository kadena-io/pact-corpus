(module kapepe-nft-gen-0-policy GOVERNANCE
  ...
  ; Constants
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  (defconst MINT_DATE "2023-08-10T16:00:00Z")
  ...
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
   ...
   (defun enforce-minted:bool (sale:string)
    ...
    (defun enforce-can-mint ()
      @doc "Enforce minting"
      (enforce (>= (at "block-time" (chain-data)) (time MINT_DATE)) "Not minting")
    )
  ...
  (defun get-minted ()
    (select nfts ["token-id"] (where 'minted (= true)))
  )

    (defun get-nfts-owned-by (owner:string)
        (select nfts ["owner", "token-id"] (where 'owner (= owner)))
    )
...
; (describe-module "n_5a7ccd559b245b7dcbd5259e1ee43d04fbf93eab.kapepe-nft-gen-0-policy")
