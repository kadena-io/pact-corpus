(module corona-token GOVERNANCE
  ...
  (defconst MINT_CHAIN:string "2"
    "ID of the chain to premine the token")

  (defconst INITIAL_SUPPLY:decimal 50000000000.0
    " Initial supply of 50 Billion tokens. (Minted on chain MINT_CHAIN)")
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard 'corona-inu-admin))
