(module backalley-dev-425f08ab-a844-40ad-a1f4-cf1d7d60dca3 GOVERNANCE
  ...
  (defconst POOL_ID:string "425f08ab-a844-40ad-a1f4-cf1d7d60dca3"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-425f08ab-a844-40ad-a1f4-cf1d7d60dca3"
  ...
  (defconst TOKEN_AMOUNT:decimal 1.850000000000
    "Amount of tokens for sale.")

  (defconst MIN_RAISE:decimal 1.100000000000
  ...
  (defconst START_DATE:time (time "2022-02-11T20:20:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-11T20:30:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T20:30:00Z")
