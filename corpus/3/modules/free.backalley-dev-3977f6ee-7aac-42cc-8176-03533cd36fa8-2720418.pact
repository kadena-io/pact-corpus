(module backalley-dev-3977f6ee-7aac-42cc-8176-03533cd36fa8 GOVERNANCE
  ...
  (defconst POOL_ID:string "3977f6ee-7aac-42cc-8176-03533cd36fa8"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-3977f6ee-7aac-42cc-8176-03533cd36fa8"
  ...
  (defconst TOKEN_AMOUNT:decimal 3.400000000000
    "Amount of tokens for sale.")

  (defconst MIN_RAISE:decimal 1.250000000000
    "Mininimum raise amount necessary for a pool to be considered successful.")

  (defconst MAX_RAISE:decimal 1.850000000000
  ...
  (defconst MAX_ALLOCATION:decimal 1.850000000000
  ...
  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T20:25:00Z")
  ...
  (defconst VESTING_PERIOD_IN_SECS:integer 86400
