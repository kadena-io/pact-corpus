(module backalley-67d2107c-ddf7-4b0e-979b-dea7656bb432 GOVERNANCE
  ...
  (defconst POOL_ID:string "67d2107c-ddf7-4b0e-979b-dea7656bb432"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-67d2107c-ddf7-4b0e-979b-dea7656bb432"
  ...
  (defconst START_DATE:time (time "2022-01-21T19:25:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-22T19:25:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-22T19:25:00Z")
