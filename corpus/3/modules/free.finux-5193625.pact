(module finux GOVERNANCE
    @doc "finux is a utility token such that 100% of the supply is dedicated to rewarding the users of finulab and ultimately supporting citizen journalism in our financial markets."
    @model [
    ...
    (defconst finulab-bank:string "finulab-bank"
        @doc "treasury account established to initially hold all the tokens allocated to the users of finulab: 100% of the supply. for more on our tokenomics, visit: finux.xyz"
    )
