(module wipper GOVERNANCE

  @doc " wipper is a new token implemented on the Kadena mainnet \
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "admin-wr"))
