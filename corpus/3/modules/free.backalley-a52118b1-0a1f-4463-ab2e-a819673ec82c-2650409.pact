(module backalley-a52118b1-0a1f-4463-ab2e-a819673ec82c GOVERNANCE
  ...
  (defconst POOL_ID:string "a52118b1-0a1f-4463-ab2e-a819673ec82c"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-a52118b1-0a1f-4463-ab2e-a819673ec82c"
  ...
  (defconst START_DATE:time (time "2022-01-26T23:22:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-26T23:28:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-26T23:28:30Z")
