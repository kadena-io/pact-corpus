(module backalley-eb9536b3-b648-4b17-98b6-e52a60b3a150 GOVERNANCE
  ...
  (defconst POOL_ID:string "eb9536b3-b648-4b17-98b6-e52a60b3a150"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-eb9536b3-b648-4b17-98b6-e52a60b3a150"
  ...
  (defconst START_DATE:time (time "2022-01-20T04:06:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-20T04:20:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-20T04:25:00Z")
