(module backalley-3e56d3e7-2b05-47cc-b2f9-5b5d2d4079d0 GOVERNANCE
  ...
  (defconst POOL_ID:string "3e56d3e7-2b05-47cc-b2f9-5b5d2d4079d0"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-3e56d3e7-2b05-47cc-b2f9-5b5d2d4079d0"
  ...
  (defconst MIN_RAISE:decimal 0.000010000000
  ...
  (defconst MIN_ALLOCATION:decimal 0.000010000000
    "Minimum individual allocation.")

  (defconst MAX_ALLOCATION:decimal 0.000100000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-01-31T23:55:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-01T00:45:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-01T00:55:00Z")
  ...
  (defconst VESTING_PERIOD_IN_SECS:integer 31536000
