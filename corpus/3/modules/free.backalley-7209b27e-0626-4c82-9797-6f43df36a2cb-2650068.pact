(module backalley-7209b27e-0626-4c82-9797-6f43df36a2cb GOVERNANCE
  ...
  (defconst POOL_ID:string "7209b27e-0626-4c82-9797-6f43df36a2cb"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-7209b27e-0626-4c82-9797-6f43df36a2cb"
  ...
  (defconst OWNER:string "k:22aee256eb5ad816ab7fe87ddd068e7b179d329449ea0faf68e41bd139d78026"
  ...
  (defconst START_DATE:time (time "2022-01-27T03:40:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-29T03:40:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-29T03:40:00Z")
