(module backalley-7175a72d-50b5-48d5-ba54-804ab81f7ad5 GOVERNANCE
  ...
  (defconst POOL_ID:string "7175a72d-50b5-48d5-ba54-804ab81f7ad5"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-7175a72d-50b5-48d5-ba54-804ab81f7ad5"
  ...
  (defconst OWNER:string "k:c158f51db6f12528a4a9d9ef37d6a76af547d8540aca20867424d7281ad8d9ac"
    "Account that initiated this pool")

  (defconst TOKEN_AMOUNT:decimal 10.000000000000
    "Amount of tokens for sale.")

  (defconst MIN_RAISE:decimal 0.000100000000
    "Mininimum raise amount necessary for a pool to be considered successful.")

  (defconst MAX_RAISE:decimal 0.010000000000
    "Maximum raise after which the pool will not accept more deposits.")

  (defconst MIN_ALLOCATION:decimal 0.000100000000
    "Minimum individual allocation.")

  (defconst MAX_ALLOCATION:decimal 0.001000000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-01-22T00:15:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-22T00:30:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-22T00:30:00Z")
    "The date after which tokens will start being available for redeem.")

  (defconst VESTING_SHARE:decimal 0.250000000000
    "Percentage of tokens available for redeem after each vesting period.")

  (defconst VESTING_PERIOD_IN_SECS:integer 15724800
