(module backalley-dev-b2bad824-4028-424c-b1bb-413be0efc414 GOVERNANCE
  ...
  (defconst POOL_ID:string "b2bad824-4028-424c-b1bb-413be0efc414"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-b2bad824-4028-424c-b1bb-413be0efc414"
  ...
  (defconst START_DATE:time (time "2022-02-11T01:00:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-11T01:30:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T01:30:00Z")
