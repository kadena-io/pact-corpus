(module backalley-5792683e-b050-4b60-a363-a1c4d29d2f7f GOVERNANCE
  ...
  (defconst POOL_ID:string "5792683e-b050-4b60-a363-a1c4d29d2f7f"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-5792683e-b050-4b60-a363-a1c4d29d2f7f"
  ...
  (defconst TOKEN_AMOUNT:decimal 1.650000000000
  ...
  (defconst START_DATE:time (time "2022-02-12T03:30:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-12T04:30:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-12T04:30:00Z")
