(module eighties-bulls 'bulls-keyset
  "80s Bulls"
    ...
    (defun create-80s-bull-for-sale (item:object)
        ...
        (increase-count BULLS_CREATED_TO_MINT_COUNT_KEY 1)
    )
    ...
    (defun buy-80s-bull (owner:string number:integer)
        ...
        (increase-count BULLS_MINTED_COUNT_KEY 1)
    )
    ...
    (defun mint-bull (id:string data:object)
        ...
        (increase-count BULLS_CREATED_COUNT_KEY 1)
    )
    ...
    (defun buy-bull-off-market
        ...
        (with-read minted-nfts id
          ...
          'price := m_price }
            ...
            (coin.transfer owner m_owner (* 0.98 m_price))
            (coin.transfer m_owner ADMIN_ADDRESS (* 0.02 m_price))
