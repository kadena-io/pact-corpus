(module KadenaZombies "free.kadena-zombies"                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      'project-kz
    ...
    (defconst ADMIN_KEYSET (read-keyset "free.kadena-zombies"))
    (defconst ADMIN_ADDRESS "k:38f1438799eb096df315d670af49c2c73ca4ab7afd6725ff7f29b6f51be8cca5")
    (defconst KZ_URI_KEY "https://kadenazombies.com/collection/")
    (defconst VAULT "k:9bec993bab2c09e07eb3ef56dcd23b14638988366622091574bb92382eb9c198")
  ...
  (defcap PRIVATE () 
    ...
    (defun buy-kzs-bulk (owner:string amount:integer)
       ...
       (if 
            (!= owner ADMIN_ADDRESS)
            (coin.transfer owner VAULT (* (get-price) amount))
            "Admin account"
        )
    ...
    (defun uri:string (id:string)
        ...
        (+ "https://kadenazombies.com/collection/" id)
