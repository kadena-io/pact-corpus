(module kasino-contract GOVERNANCE

  "'kasino-contract' represents Kasino Testnet Contract."
  ...
  (defcap GOVERNANCE ()
    (enforce-guard (at 'guard (details 'kasino-contract-admins )))
  true)
  ...
  (defconst KASINO_ACCOUNT:string 'kasino-contract )
  ...
  (defun kasino-guard:guard () (create-module-guard 'kasino-main ) )
