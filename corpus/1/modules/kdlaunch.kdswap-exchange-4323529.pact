(module kdswap-exchange GOVERNANCE
  ...
  (defun enforce-private-reserve:bool
      (pair-key:string token:module{fungible-v2})
    (require-capability (PRIVATE_RESERVE pair-key token)))
  ...
  (defun swap
    ...
    (let*
      ...
      (with-capability (PRIVATE_RESERVE pair-key token)
