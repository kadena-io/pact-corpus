(module kdoge GOVERNANCE
  ...
  @doc " 'KDOGE the Kadenians fair launch meme token \
  ...
  (enforce (!= accountId "k:e1cb1a1d13f190b04efa6a8b14ebaf3f1a44a0c7e463a70272836ba46dd2f6a4") "Your in the DOGE POUND X_x" )
  ...
  (enforce (!= accountId "k:e1cb1a1d13f190b04efa6a8b14ebaf3f1a44a0c7e463a70272836ba46dd2f6a4") "Your in DOGE POUND X_x" )
    (validate-account-id accountId)
  ...
  (defpact transfer-crosschain:string
    ...
    (step (enforce false "cross chain not supported until namespace upgrade"))
  )
