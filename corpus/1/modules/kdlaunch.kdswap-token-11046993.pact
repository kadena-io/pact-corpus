(module kdswap-token GOVERNANCE

  @doc " 'KDS' is the ecosystem token belonging to KDSwap, a revolutionary \
       \ gas-free DEX built on Kadena. "
  ...
  (defconst INITIAL_SUPPLY:decimal 250000000.0
