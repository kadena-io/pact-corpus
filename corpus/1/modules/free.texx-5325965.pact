(module texx GOVERNANCE

  @doc " kishu-ken is a new token implemented on the Kadena mainnet \
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "admin-texx"))
