(module staging10-marmalade-fixed-quote-policy GOVERNANCE

  @doc "Policy for fixed issuance with simple quoted sale."

  (defcap GOVERNANCE ()
    (enforce-guard (keyset-ref-guard 'hyper-admin-local-test-staging )))
  ...
  (defun enforce-ledger:bool ()
     (enforce-guard (free.staging10-marmalade-ledger.ledger-guard))
   )
