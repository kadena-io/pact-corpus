(module kishu-ken-nft GOV
  "Kishu Ken NFT"

    (defconst NFTS_TO_MINT_COUNT 1000.0)  
    (defconst MINT_START_TIME "2022-09-12T12:00:00Z")
    (defconst MINT_END_TIME "2022-09-17T19:00:00Z")
    ...
    (defconst ADMIN_KEYSET (read-keyset 'kishu-keyset))
    (defconst ADMIN_ADDRESS "k:089b297cd59bc847ea09bd039dea7652d90901a59d7a61923bef3cf0c3b334ec")
    (defconst CREATOR_ADDRESS "k:fb867f6b3d68cd2eeb78111f2a6a5b809150e59d7ff955a07d8f62352be0e62f")
    (defconst ROYALTY_FEE 6.9)
    (defconst LAUNCHPAD_MINT_FEE 0.1)
    ...
    (defun initialize ()
        ...
        (insert price PRICE_KEY {"price": 48.0})
        (insert values CURR_WL_ROLE_KEY {"value": ""})
    ...
    (defun mint-nfts-bulk (owner:string amount:integer)
       @doc "Mints NFTs bulk"
        ...
        (enforce-mint-live)
        (coin.transfer owner CREATOR_ADDRESS (* (- 1.0 LAUNCHPAD_MINT_FEE) (* (get-mint-price) amount)))
        (coin.transfer owner ADMIN_ADDRESS (* LAUNCHPAD_MINT_FEE (* (get-mint-price) amount)))
    ...
    (defun transfer:string (receiver:string id:string)
        ...
        (with-capability (OWNER id)
            (write marketplace id {"owner": receiver})
