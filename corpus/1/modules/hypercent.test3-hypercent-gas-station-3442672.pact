(module test3-hypercent-gas-station GOVERNANCE
  (defcap GOVERNANCE ()
    (enforce-guard (keyset-ref-guard 'hyper-admin-1)))
  ...
  (defconst GAS_STATION "hype-free-gas3")
    ...
    (coin.create-account GAS_STATION
      (guard-any
        [
          ...
          (keyset-ref-guard "hyper-admin-1" )
        ]))
  )
