(module wiza ADMIN
  ...
  (implements fungible-v2)
    ...
    ;(bless "tkfMZwmw6thRRqDymxBPigd7MJTrzudWxdHUNpcgsew")
  ...
  ; --------------------------------------------------------------------------
    ...
    (defun stake (idnft:string sender:string m:module{wizarena-interface-v1})
        ...
        (let (
            ...
            (with-capability (OWNER sender idnft m)
