(module teckel GOVERNANCE

@doc " $TECKEL smart contract for initial supply. \
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset "free.admin-teckel")
  )
  ...
  ; Constants
   ...
   (defconst TOKEN_NAME "TECKEL"
	"the name of the token")
 
  (defconst ROOT_ACCOUNT_ID:string 'ROOT
    " ID for the account which initially owns all the tokens. ")

  (defconst INITIAL_SUPPLY:decimal 21000000000000.0
    " Initial supply of 21Trillion tokens. ")
