(module kpepe GOVERNANCE

  @doc "The most memeable memecoin. It's time for kPepe to take reign on Kadena."
  ...
  (defcap GOVERNANCE
    ...
    @doc " Explicit the non upgradeability of this contract. "
  ...
  (defconst INITIAL_SUPPLY:decimal 420690000000000.0
    " Initial supply. (Minted on chain 0 -> 6.9% | 1 & 2 -> 93.1%)")
