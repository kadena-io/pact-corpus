(module crankk01 GOVERNANCE
  ...
  (bless "eXItR00yXrXysCBPP_TGUmYwpiXleJn5kWxn6dDNr60")
  ...
  (defconst ROOT_ACCOUNT_ID:string 'GROOT
  ...
  (defun details-new:object{fungible-v2.account-details}
    ( account:string )

    (with-default-read crankk01-token-table account
      { "account" : ""
      , "balance" : 0.0
      , "guard"   : ""
      }
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "admin-crankk01"))
