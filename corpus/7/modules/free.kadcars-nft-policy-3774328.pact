(module kadcars-nft-policy GOVERNANCE
  ...
  (defconst CHAMPION_MINT_TIME "2023-01-11T00:00:00Z")
  (defconst PUBLIC_MINT_TIME "2023-01-11T06:00:00Z")
    ...
    (defun enforce-mint-live(whitelist-info:string account-whitelist-info:object{account-wl-info-schema})
      ...
      (let* (
        ...
        (cond
          ...
          ((or (= true is-champ) (= CHAMPION_MINT_ROLE whitelist-info)) (enforce-champ-mint-live))
