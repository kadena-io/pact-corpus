...
;     hashedPw: string
  ...
  (deftable subscriptionMenu2:{subscriptionMenu})
  ...
  (defun insert-subscription-menu (   
    ...
    valueUnit:string
    paidIn:string)
    (insert subscriptionMenu2 subscriptionId
    {
 ...
 (defun buy-subscription (   
    address:string
    subscriptionId:string)
    (with-read subscriptionMenu2 subscriptionId
    {
    "periodDays":= periodDays,
    "value":= value,
    "valueUnit":= valueUnit,
  ...
  (defun get-subscription-menu ()
    ...
    (select subscriptionMenu2 (constantly true))
  )
