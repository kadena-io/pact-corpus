(module kapybara-token GOVERNANCE
  ...
  (bless "323KiJhPUTu03Kgn_fHL0fMnLN0ddiedihzb131e7ns")
  (bless "n2X1hOjD2_mVG3lY44jme33VmSw_h-Z7_cEwNDQptGU")
  ...
  (defconst INITIAL_SUPPLY:decimal 1000000000000.0
    " Initial supply of 1 Trillion tokens. (Minted on chain MINT_CHAIN)")
...
; (free.kapybara-token.initialize)
