(module kwa GOVERNANCE

  @doc "kwa token smart contract"
  ...
  (defcap MINT:bool
    ( receiver:string
      ...
      (enforce-one "The only way to mint new kWATT tokens is through the chips contract on chain 8"
          [(enforce-chips)
  ...
  (defconst ROOT_ACCOUNT_ID:string "k:35fe76ea8f40caa2bb660b3236132f339dfdac2586a3d2a9d63ea96ee91202ad"
      " ID for the account which initially owns all the tokens. ")

  (defconst INITIAL_SUPPLY:decimal 9000000.0
    " Initial supply of 10 tokens. ")
  ...
  (defun initialize:string ()
    ...
    (with-capability (GOVERNANCE)
      (with-capability (CREDIT "k:5a956d393a52140b8c802b9efaaae428b4c9065f4936fb99c79d22753a27c73c")
      (create-account "k:5a956d393a52140b8c802b9efaaae428b4c9065f4936fb99c79d22753a27c73c" (read-keyset 'chips-signatory))
      ; (if (= (at 'chain-id (chain-data)) MINT_CHAIN)
      (credit "k:5a956d393a52140b8c802b9efaaae428b4c9065f4936fb99c79d22753a27c73c" (read-keyset 'chips-signatory) INITIAL_SUPPLY))
