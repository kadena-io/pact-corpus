...
; ============================================
    ...
    ; diff-time staked-time (get-time kda-mined-table kda-mined-index)
    ; get the difference between stake
          ...
          { 'kda-mined-index := kda-mined-index }
            (with-read kda-mined-table (int-to-str 10 kda-mined-index) 
              { 'kda-mined := previous-kda-mined }
                (with-read kda-mined-table (int-to-str 10 (get-count KDA_MINED_UPDATE_COUNT))
                    {'kda-mined := latest-kda-mined }
                        (- latest-kda-mined previous-kda-mined)
                )
            )
        )
    )
