(module fsyc-pre-sale GOVERNANCE
  ...
  (defconst FSYC_PER_USER:integer 225)
  (defconst FSYC_SALE_SUPPLY:decimal 225.0)
  (defconst SALE_START_TIME:time (time "2022-10-02T00:00:00Z"))
  (defconst WHITELIST_TIME:time (time "2022-10-01T00:00:00Z"))
  (defconst END_TIME:time (time "2022-12-02T00:00:00Z"))
