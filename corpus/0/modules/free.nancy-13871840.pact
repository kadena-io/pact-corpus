(module nancy GOVERNANCE

  @doc " 'Nancy' is the first token to celebrate pelosi trades \
       \ nancy is a great trader. "
  ...
  (defconst INITIAL_SUPPLY:decimal 50000.0
    " Initial supply of 100 million tokens. (5mm x20 chains)")
