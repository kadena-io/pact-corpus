(module yeettoken GOVERNANCE

  @doc " 'yeettoken' is a token implemented on the Kadena mainnet \
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset 'admin-yeettoken)
  )
  ...
  (defconst INITIAL_SUPPLY:decimal 55000000000.0
    " Initial supply of 55 billion tokens")
