(module sway GOVERNANCE

  @doc " 'Sway ' is a token implemented on the Kadena mainnet \
  ...
  (defconst INITIAL_SUPPLY:decimal 0.0
    " Initial supply of 1 billion tokens. (1000000000x1 chain)")
