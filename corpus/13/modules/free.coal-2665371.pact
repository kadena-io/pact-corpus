...
;(create-table coal-tbl)
;(create-table coal-int-settings-kv-tbl)
;(create-table nofrontrun-tbl)
;(insert coal-int-settings-kv-tbl coal.COALS_MINTED_COUNT_KEY {'teh-val : 0})
;(insert coal-int-settings-kv-tbl coal.COALS_RUNNING_STATE_KEY {'teh-val : coal.COALS_ARE_RUNNING_VALUE})
