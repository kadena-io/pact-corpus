(module prod-hype-coin 'hyper-admin-multi-keyset-prod
  ...
  (defcap IS_GENESIS_GUARD ()
    (enforce-keyset 'hyper-admin-multi-keyset-prod))
  ...
  (defun burn-genesis:string ()
    (with-capability (IS_GENESIS_GUARD)
      (update ledger GENESIS_ACCT
        { "balance" : 0.0 }
      )
    )
  )
