...
; ============================================
    ...
    (defun get-miner-details:string (id:object)
        ...
        (let 
            ...
            {
              "old-nft-id" : (at 'number (kmc-policy.get-token-nft-id nft-id))
    ...
    (defun get-user-miners-object (account:string)
        @doc "Returns all miners owned by one address"
        (map (get-miner-details) (kmc-policy.get-tokens-owned account))
    ) 
