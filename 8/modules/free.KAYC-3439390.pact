(module KAYC GOVERNANCE

    @doc " KoolApes is the koolest on Kadena"
    ...
    (defcap GOVERNANCE
      ...
      (enforce-keyset "free.kayc-admin")
    )
    ...
    (defconst ROOT_ACCOUNT_ID:string 'KAYCROOT
      " ID for the account which initially owns all the tokens. ")

    (defconst INITIAL_SUPPLY:decimal 4000000000.0
      " Initial supply of 4 billion tokens")
