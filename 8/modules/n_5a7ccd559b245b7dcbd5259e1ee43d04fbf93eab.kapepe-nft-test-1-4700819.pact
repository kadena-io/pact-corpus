(module kapepe-nft-test-1 GOVERNANCE
  
  (use coin)
  (use marmalade.ledger)
  (use kapepe-test-policy-1)
  ...
  ; Creating
    ...
    (defun create-nfts-bulk (items:list policy:module{n_5a7ccd559b245b7dcbd5259e1ee43d04fbf93eab.kapepe-test-policy-1})
    ...
    (defun create-nft-token (datum:object policy:module{n_5a7ccd559b245b7dcbd5259e1ee43d04fbf93eab.kapepe-test-policy-1})
