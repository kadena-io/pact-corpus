(module secret-garden-of-kadena-gen-1-policy GOVERNANCE
  ...
  (defconst PRIVATE_WL_MINT_START_TIME "2024-05-15T16:00:00Z")
  ...
  (defun get-price-by-phase:decimal(current-phase:string)
    (cond
        ((= OG_PHASE current-phase) 13.4020618557)
        ((= PRIVATE_WL_PHASE current-phase) 17.5257731959)
        ((= PUBLIC_PHASE current-phase) 20.618556701)
        10000000.0)
  )
