            ...
            (with-capability (MINT (at "id" token) account)
                ...
                (let* 
                    (
                     ...
                     (cond 
                        ( (= purpose "gen-0-rewards" ) (enforce-mint-g0-rewards-v2 token account guard 1.0 account-info))
                        ( (= purpose "bh-rewards" ) (enforce-mint-bh-rewards-v2 token account guard 1.0 account-info))
      ...
      ( token:object{token-info}
        ...
        account-info:object{account-wl-record-schema})
            ...
            (let*
                ...
                (enforce (or (> split-id-number 9900) (= split-id-number 9900)) "ID not slated for public mint")
        ...
        ( token:object{token-info}
          ...
          account-info:object{account-wl-record-schema})
                ...
                (let*
                    ...
                    (enforce (< split-id-number 9650) "ID not slated for staking")
                    (update-account-info-for-rewarded-nfts account account-info)
                    (bind (get-policy token)
                        { "owner":=owner:string}
                        (enforce (= (+ amount (at "supply" token)) 1.0) "Exceeds max supply")
        ...
        ( token:object{token-info}
          ...
          account-info:object{account-wl-record-schema})
                ...
                (let*
                    ...
                    (enforce (< split-id-number 9650) "ID not slated for staking") ;;9951 part of staking instead of public mint
                    (update-account-info-for-rewarded-nfts account account-info)
                    (bind (get-policy token)
                        { "owner":=owner:string}
                        (enforce (= (+ amount (at "supply" token)) 1.0) "Exceeds max supply")
