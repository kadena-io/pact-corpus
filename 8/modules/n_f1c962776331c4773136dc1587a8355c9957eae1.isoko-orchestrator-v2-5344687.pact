...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  ...
  (defun create-nft-token-v2:string(collection-id:string policies:[module{kip.token-policy-v2}] creator-guard:guard token-details:object)
    @doc "Creates a manifest then builds a marmalade token using supplied policy"
    (require-capability (CREATE-NFT collection-id))
    (let*
      (
        (uri-obj (at "uri" token-details))
        (uri (at "data" uri-obj))
