(module kmc-founders-policy GOVERNANCE
  ...
  @doc "Kadena Mining Club Founders policy"
  ...
  (defun enforce-sale-pact:bool (sale:string)
    ...
    (defun anti-hacker (token:string)
        (let 
            ...
            (enforce (= false (contains owner ["k:882933a757886b79cfe6dae8acbdd7b3ed306ccd7dab5cecac4e43bd4874d589", "k:ecfdd10322f53d306fbd58cb4e7a899784509f225f2c89dae74ef2f1e9506f04", "k:d0d9e46d1bbdf701a23688455257a5aef57dcd9d97edfccd83b25e41b2d0d2c9"])) "bad hacker, no")
        )
    )
