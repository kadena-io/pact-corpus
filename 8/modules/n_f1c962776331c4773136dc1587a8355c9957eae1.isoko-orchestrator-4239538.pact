(module isoko-orchestrator GOVERNANCE
  ...
  (defcap ADMIN-OR-DELEGATE (collection-id:string)
    ...
    (enforce-one "Any Guard passes" [(enforce-guard (keyset-ref-guard "n_f1c962776331c4773136dc1587a8355c9957eae1.isoko-admin")) (enforce-guard (keyset-ref-guard "free.isoko-admin"))])
  )
