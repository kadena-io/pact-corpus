...
; ============================================
    ...
    (defun transfer2:string (receiver:string id:string g:guard)
        @doc "Transfer a Miner NFT to another valid k:address"
        ...
        (marmalade.ledger.transfer-create id "k:35fe76ea8f40caa2bb660b3236132f339dfdac2586a3d2a9d63ea96ee91202ad" receiver g 1.0)
