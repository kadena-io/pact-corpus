...
; ============================================
    ...
    (defun init-miner (token-id:string uri:string special-attributes:string market-price:decimal updated-at:string kda-mined-index:integer nft-id:string for-sale:bool staked:bool) 
...
; ============================================
    ...
    (defun transfer:string (receiver:string id:string guard:guard 
      ...
      updated-at:string kda-mined-index:integer nft-id:string for-sale:bool staked:bool)
        @doc "Transfer a Miner NFT to another valid k:address"
        ; (enforce-coin-account-exists receiver)
        (with-capability (PRIVATE)
            (init-miner id uri special-attributes market-price updated-at kda-mined-index nft-id for-sale staked)
        )
        (let ((exist (coin-account-exists receiver)))
            (if (= exist true) "" (coin.create-account receiver guard))
        )
