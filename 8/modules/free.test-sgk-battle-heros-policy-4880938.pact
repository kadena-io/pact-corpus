(module test-sgk-battle-heros-policy GOVERNANCE
  ...
  ; Constants
  ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
  (defconst PUBLIC_MINT_TIME "2023-09-15T16:30:00Z")
  (defconst FREE_MINT_TIME "2023-09-15616:30:00Z")
    ...
    (let*
        ...
        (write account-wl-records account
           { 'minted-total : (+ 1 (at 'minted-total account-info))
            ,'account : account
            ,'free-mints-granted : (if (= true shouldDeductFreeMints) (+ free-mints-granted 1) free-mints-granted)
