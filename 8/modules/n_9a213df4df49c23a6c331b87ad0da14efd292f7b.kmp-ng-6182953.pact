(module kmp-ng  GOVERNANCE
    @doc "Manage Kadena Monster Punks NG NFT's"
    ...
    ; Functions
    ; --------------------------------------------------------------------------
    (defun create-kmp-collection (col-name:string)
        ...
        (with-capability (PRIVATE)
            (let*
                ...
                (create-collection collection-id col-name 1000 creator collection-guard)
    ...
    (defun create-mint-tokens (collection-id:string)
        ...
        (with-capability (PRIVATE)
            (let* 
                ...
                (enforce (!= col-id false) "Collection ID does not exist in KMP collections!")
