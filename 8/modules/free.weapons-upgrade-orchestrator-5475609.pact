(module weapons-upgrade-orchestrator GOVERNANCE
    ...
    ; Constants
    ; --------------------------------------------------------------------------
    (defconst SGK_ADDRESS "k:3a665827b7414a6bef01b434bf27b2911266569e9d0bd2b2420ee28df8a5a9c0");"k:80427d276c409892b1ff95582468ad0cab3b8aa033ef06a4a13210127c97d4c7"
    ...
    (defun get-next-mint-token (token-id:string)
        ...
        (let*
            (
                ...
                (next-mint-id (+ 1 (get-count (concat ["level-" (int-to-str 10 next-id)]))))
