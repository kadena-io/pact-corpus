(module sgk-weapons-policy-13-4 GOVERNANCE @doc "Policy for fixed issuance with royalty and quoted sale in specified fungible."
...
(defconst MAX-UNIQUE-SUPPLY 1250
    @doc "Max unique supply")
  ...
  ( token:object{token-info}
    ...
    account-info:object{account-wl-record-schema})
        ...
        (let*
            ...
            (enforce (<= split-id-number 1245) "id is not slated for public mint")
