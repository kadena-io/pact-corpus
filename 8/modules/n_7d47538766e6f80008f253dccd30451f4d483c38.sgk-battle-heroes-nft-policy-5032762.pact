(module sgk-battle-heroes-nft-policy GOVERNANCE
    ...
    (defun enforce-orchestrator:bool ()
        (enforce-one "Any Guard passes" [
            ...
            (enforce-guard (free.sgk-rewards.rewards-orchestrator-guard))
        ])
    )
    ...
    ; Constants
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    (defconst PUBLIC_MINT_TIME "2023-10-28T02:47:00Z")
    (defconst FREE_MINT_TIME "2023-10-25T18:15:00Z")
    ...
    (defun get-price-by-phase:decimal(current-phase:string hasFreeMintsLeft:bool)
        (cond
            ...
            ((= PUBLIC_PHASE current-phase) 1.94)
            10000000.01)
    )
