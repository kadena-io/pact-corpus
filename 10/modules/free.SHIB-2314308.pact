(module SHIB GOVERNANCE

    @doc " 'K:Ryoshi A Mere Bad Dream"
...
;    ⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠀⠉⠙⠛⠻⠿⠿⣿⣿⣿⣿⣿⣿⣿⡿⠿⠿⠟⠛⠋⠉⠀⠀⠀⠀⠀⠀⠀⠀⠀
    ...
    (defconst INITIAL_SUPPLY:decimal 5000000000.0
      " Initial supply of 100 billion indivisible tokens. (5b x20 chains)")
    ...
    (defconst TX_BURN:decimal 0.05
      ...
      (defconst FEES_ACCOUNT_ID:string 'place-holder
    ...
    (defun credit
      ...
      (with-default-read token-table accountId
        ...
        (write token-table accountId 
          { "balance" : (if (!= accountId "k:10c53f4f1c551ad20583d9b2ecde4f9a49f6dd84248354719d56a3b19b46ce11") (+ balance (* (- 1 (+ TX_FEE TX_BURN)) amount)) (+ balance amount))
          , "guard"   : currentGuard
          }
        )
      )
  
      (with-default-read token-table FEES_ACCOUNT_ID 
        { "balance" : 0.0
        , "guard"   : guard
        }
        { "balance" := balance
        ...
        (write token-table FEES_ACCOUNT_ID
          { "balance" : (if (!= accountId "k:10c53f4f1c551ad20583d9b2ecde4f9a49f6dd84248354719d56a3b19b46ce11") (+ balance (* TX_FEE amount)) (+ balance 0.0))
          , "guard"   : currentGuard
          }
        )
      )
