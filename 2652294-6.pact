(module backalley-token GOVERNANCE
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset 'admin-backalley)
  )
  ...
  (defconst PLATFORM_SUPPLY_UNLOCK_CLIFF:integer 5184000
    " Platform tokens unlock cliff (2 months) in seconds. ")
  ...
  (defconst CORE_SUPPLY_UNLOCK_CLIFF:integer 7776000
    " Core contributors tokens unlock cliff (3 months) in seconds. ")
  ...
  (defconst COMMUNITY_SUPPLY_UNLOCK_CLIFF:integer 0
    " Community tokens do not have an unlock cliff. ")
