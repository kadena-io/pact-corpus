(module brawler-bears GOV
    ...
    (let* ((mp-data (read marketplace bear-id))
           (bear (read nft-main-schema bear-id))
      ...
      (with-capability (OWNER bear-id)
        (if (= attack-one "")
          (update nft-main-schema bear-id {"attack-one": attack-id})
          (if (= attack-two "")
            (update nft-main-schema bear-id {"attack-two": attack-id})
            (if (= attack-three "")
              (update nft-main-schema bear-id {"attack-three": attack-id})
    ...
    (let* ((bear (read nft-main-schema bear-id))
            (current-battle-id (at 'current-battle-id bear))
            (attack-one (at 'attack-one bear))
            (attack-two (at 'attack-two bear))
            (attack-three (at 'attack-three bear)))
    ...
    (with-capability (OWNER bear-id)
        ...
        (update nft-main-schema bear-id {"attack-one": ""})
        (if (= attack-two attack-id)
            (update nft-main-schema bear-id {"attack-two": ""})
            (if (= attack-three attack-id)
            (update nft-main-schema bear-id {"attack-three": ""})
    ...
    (defun perform-attack (nft-id:string battle-id:string attack-id:string)
      ...
      (with-capability (OWNER nft-id)
        (let*
          (
            ...
            (attack (free.brawler-bears-attacks.get-nft-fields-for-id [""] attack-id))
    ...
    (defun get-image-uri (id:string)
      ...
      (defun backfill-metadata-item (item:object)
          ...
          (let (
                ...
                (attackOne (at "attackOne" item) )
                (attackTwo (at "attackTwo" item) )
                (attackThree (at "attackThree" item) )
              )
            (update nfts id {
                "id": id,
                "level": level, 
                ...
                "attack-one": attackOne,
                "attack-two": attackTwo,
                "attack-three": attackThree,
                "total-games-played": "",
                "total-wins": "",
                "total-losses": "",
                "total-damage-given": "",
