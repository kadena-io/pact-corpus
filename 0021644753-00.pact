          ...
          {"offeror":= offerorB,
           ...
           (let*
             ((revrate (/ 1 rateB))
              ...
              (install-capability (token1A::TRANSFER CRANKKX_BANK offerorA effamntA))
              (token1A::transfer CRANKKX_BANK offerorA effamntA)
        
              (install-capability (token1B::TRANSFER CRANKKX_BANK offerorB effamntB))
              (token1B::transfer CRANKKX_BANK offerorB effamntB)
