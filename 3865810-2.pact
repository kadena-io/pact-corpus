...
; ============================================
    ...
    (defconst DISCORD_ADDRESS "k:292fd9c4dcc65aa858e1855705ada00093594ce66e8811c2b19638ce1681bfb0")
...
; ============================================
    ...
    (defun add-to-wl-for-role (role:string accounts:list calling-account:string)
        ...
        (enforce
            (or? (= (or? (= (or? (= WL_KD2_ROLE) (= WL_KD5_ROLE) role)) (= (or? (= WL_KD2_ROLE) (= WL_KD7_ROLE) role)) true)) (= (or? (= WL_KD8_ROLE) (= WL_KD6_ROLE) role)) true)
