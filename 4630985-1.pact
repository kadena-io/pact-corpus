(module tfm-mok-token GOVERNANCE
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset 'tfm-mok-admin-multi-keyset)
  )
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard 'tfm-mok-admin-multi-keyset))
  ...
  (defun init-hype-escrow:string ()
    (update token-table free.tfm-mok-vesting.MOK_HYPE_ESCROW { "balance" : 800000.0 })
  )
)
