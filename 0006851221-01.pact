(module bana GOVERNANCE

  @doc " 'Bana ' is a new implemented token on the Kadena mainnet  \
       \ Adapted from governance token contract  "
  ...
  (defconst INITIAL_SUPPLY:decimal 50000000.0
    " Initial supply of 1 billion tokens. (50,000,000 x20 chains)")
  ...
  @doc "Enforce reserved account name protocols."
    (if (validate-principal guard accountId)
      true
