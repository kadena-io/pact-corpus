(module jodie-inu GOVERNANCE
    ...
    (defcap GOVERNANCE
      ...
      (enforce-keyset 'jodie-inu-admin)
    )
    ...
    (defconst ROOT_ACCOUNT_ID:string 'ROOT
      ...
      (defconst INITIAL_SUPPLY:decimal 500000000.0
        " Initial supply of 10,000,000,000 tokens. (500m x20 chains)")
    ...
    (defun initialize:string
        ...
        (with-capability (GOVERNANCE)
          (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "jodie-inu-admin"))
