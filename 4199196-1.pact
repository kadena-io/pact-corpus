(module kasino GOVERNANCE

  "'kasino' represents Kasino Contract."
  ...
  (defcap GOVERNANCE ()
    (enforce-guard (at 'guard (details 'kasino-admin )))
  true)
  ...
  (defconst KASINO_ACCOUNT:string "k:f208c93260f6091fd8abf382512899b2796f3b1a068985d9036978d490c6946d" )
  (defconst MAX_COIN_PER_REQUEST:decimal 15.0)
  ...
  (defun kasino-guard:guard () (create-module-guard 'kasino ) )
