(module km-marketplace GOVERNANCE
    ...
    (defcap GOVERNANCE ()
      ...
      (defun get-royalty (collectionName:string)
        ...
        (defun set-royalty-launchpad (name:string royaltyRate:decimal royaltyAccount:string)
                ...
                (write royalty name
                  {
                   ...
                   (write collection-info name
                     {
                       "creator":"k:6d3408f25312d5342ea5513707cc18dfd7b2a2c30decd0250d6f6491bbbfcf32",
                       "collectionName":name,
                       "royaltyAccount":royaltyAccount,
                       "royaltyRate":royaltyRate
                       })
