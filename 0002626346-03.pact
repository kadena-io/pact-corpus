(module backalley-e9097cbd-e629-4ac6-b718-94f5b0d978a0 GOVERNANCE
  ...
  (defconst POOL_ID:string "e9097cbd-e629-4ac6-b718-94f5b0d978a0"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-e9097cbd-e629-4ac6-b718-94f5b0d978a0"
  ...
  (defconst MIN_RAISE:decimal 0.010000000000
  ...
  (defconst MIN_ALLOCATION:decimal 0.000000000100
    "Minimum individual allocation.")

  (defconst MAX_ALLOCATION:decimal 1.000000000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-01-21T01:00:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-21T01:10:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-21T01:20:00Z")
