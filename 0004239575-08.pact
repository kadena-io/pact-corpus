(module isoko-free-test-policy-1 GOVERNANCE
  ...
  (defconst PRIVATE_WL_MINT_END_TIME "2023-04-21T10:30:00Z")
  (defconst PUBLIC_MINT_TIME "2023-04-21T11:18:00Z")
  ...
  (defconst MINT-CAP-FOR-PRIVATE-WL-SALE 10
  ...
  (defun enforce-init:bool
    ...
    (enforce (= false true) "0 fail")
    (enforce-orchestrator)
    (enforce (= false true) "1 fail")

    (enforce-ledger)
    (enforce (= false true) "2 fail")

    (with-capability (CREATE)
    (enforce (= false true) "3 fail")
