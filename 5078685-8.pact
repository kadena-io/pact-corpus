    ...
    (defun TEST-get-and-decrement-random-staking-reserve-collection:string (rand:integer)
        ...
        (let* 
            (
                ...
                (collection-types-list:list (map (lambda (x) (+ "test-sgk-weapons-2-1" x)) collection-suffix-strings-list))
                ...
                (enforce (> 0 number-of-non-empty-cols) "No NFTs left for staking rewards");;ADDED
