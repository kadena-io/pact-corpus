(module kimki GOVERNANCE

  @doc " Good evening to anyone who thinks that there may be something serious Ahusharmota in here  \
       \ Kimki is in the house. hide your bitches. \
       \ Welcome Kadena ecosystem fam, you came early. "
  ...
  (defconst INITIAL_SUPPLY:decimal 50000000000000.0
    " Initial supply of 1,000,000,000,000,000 tokens. (500k 50,000,000,000,000 x20 chains)")

  (defconst DECIMALS 12
    " Specifies the minimum denomination for token transactions. ")

  (defconst TOKEN_VALUE 2000000000.0
    " 2,000,000,000 Per 1 KDA ")
  ...
  (defun initialize:string
    ...
    (with-capability (GOVERNANCE)
      (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "admin-kimki"))
