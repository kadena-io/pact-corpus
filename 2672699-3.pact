(module backalley-a2549914-b402-48aa-bad5-279da7d18997 GOVERNANCE
  ...
  (defconst POOL_ID:string "a2549914-b402-48aa-bad5-279da7d18997"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-a2549914-b402-48aa-bad5-279da7d18997"
  ...
  (defconst START_DATE:time (time "2022-02-01T05:50:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-01T06:50:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-01T06:50:00Z")
