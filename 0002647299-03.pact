(module backalley-7beea16a-4335-410d-9339-3b41c4f4a789 GOVERNANCE
  ...
  (defconst POOL_ID:string "7beea16a-4335-410d-9339-3b41c4f4a789"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-7beea16a-4335-410d-9339-3b41c4f4a789"
  ...
  (defconst TOKEN_AMOUNT:decimal 500.000000000000
  ...
  (defconst START_DATE:time (time "2022-01-26T03:56:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-26T04:02:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-26T04:03:00Z")
