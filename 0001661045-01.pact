(module taxfee GOVERNANCE

  @doc " 'First transaction taxation model on Kadena. Made by Thanos' 5% taxed "
  ...
  (defconst FEES_ACCOUNT_ID:string 'ROOT
    " ID of the account receiving the fees ")
