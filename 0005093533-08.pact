(module isoko-orchestrator GOVERNANCE
  ...
  (defconst SGK_WEAPONS_LEVEL_ONES ["test-sgk-weapons-4-1" "test-sgk-weapons-5-1" "test-sgk-weapons-6-1" "test-sgk-weapons-7-1" "test-sgk-weapons-8-1" "test-sgk-weapons-9-1"
    "test-sgk-weapons-10-1" "test-sgk-weapons-11-1" "test-sgk-weapons-12-1" "test-sgk-weapons-13-1" "test-sgk-weapons-14-1" "test-sgk-weapons-15-1"]
    @doc "Max Unique Tokens in a collection")
            ...
            (let* 
                (
                   ...
                   ;; (all-weapon-lvl-1-collections:list (n_f1c962776331c4773136dc1587a8355c9957eae1.sgk-rewards-util.get-col-names))
                    (token-ids-to-mint:list (map (TEST_claim-weapon-staking owner guard SGK_WEAPONS_LEVEL_ONES) claim-list))
                )
                (map (mint owner guard) token-ids-to-mint)
            )
        )
