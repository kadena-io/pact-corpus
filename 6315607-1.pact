(module sphynxxx-cats GOV
    "SphynXXX Cats Mint"
  
    (defconst NFTS_TO_MINT_COUNT 1000.0)  
    (defconst WL_MINT_PRICE 7.0)
    (defconst PUBLIC_MINT_PRICE 10.0)
    (defconst WL_MINT_START_TIME "2022-12-01T19:00:00Z")
    (defconst PUBLIC_MINT_START_TIME "2022-12-02T19:00:00Z")
    (defconst MINT_END_TIME "2022-12-08T19:00:00Z")
    (defconst MAX_WL_MINT 1000)
    ...
    (defconst CREATOR_ADDRESS "k:b5c7d29b1aa60d195934d53e818f9f6482093e882643cf009943b565acec62d1")
