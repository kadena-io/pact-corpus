(module newest-token-admin GOVERNANCE

    @doc " 'Newest-Token' is one of the meme tokens launched on the Kadena Network. "
    ...
    (defcap GOVERNANCE
      ...
      (enforce-keyset 'newest-token-admin)
    )
    ...
    (defun initialize:string
        ...
        (with-capability (GOVERNANCE)
          (create-account ROOT_ACCOUNT_ID (keyset-ref-guard "newest-token-admin"))
