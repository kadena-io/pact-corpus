(module variationapes-token GOVERNANCE

  @doc " 'Variationapes' is the token implemented on the Kadena mainnet."
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset 'variationapes-admin-keyset20221028)
  )
