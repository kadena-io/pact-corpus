(module kayc-sale-manager GOV

  ; Custom Values: Token name, guards, accounts
  (defconst KDA_BANK_ACCOUNT:string "kayc-sale-bank" )
  (defconst KDA_BANK_GUARD_NAME:string "free.kayc-bank-admin" )
  (defconst GOV_GUARD_NAME:string "free.kayc-sale-gov")
  (defconst OPS_GUARD_NAME:string "free.kayc-sale-ops" )
  (defun kda-bank-guard () (create-module-guard KDA_BANK_GUARD_NAME))
  (defconst TOKEN_NAME:string "KAYC" )
