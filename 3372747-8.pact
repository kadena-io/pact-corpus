(module prod-community-v2 GOVERNANCE
  (defcap GOVERNANCE ()
  ...
  (defconst TICKETS_PRICE [0.0,200.00,230.00,265.00,305.00,350.00,405.00,465.00])
  (defconst GA_PRICE [1000000.00,1220000.00,1490000.00,18200000.00,22200000.00])
  ...
  (defun add-rewards-for-staking (project:string account:string amount:decimal tickets:integer ga:integer)
        ...
        (let* (
              (locking-contract:module{callable-v3} (hypercent.prod-callable-contracts.get "hype-locker"))
