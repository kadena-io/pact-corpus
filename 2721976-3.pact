(module backalley-6a813e6a-2084-487f-9e9c-3ade46f05b98 GOVERNANCE
  ...
  (defconst POOL_ID:string "6a813e6a-2084-487f-9e9c-3ade46f05b98"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-6a813e6a-2084-487f-9e9c-3ade46f05b98"
  ...
  (defconst START_DATE:time (time "2022-02-12T04:10:00Z")
  ...
  (defconst VESTING_SHARE:decimal 0.001000000000
