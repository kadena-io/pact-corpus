(module backalley-7c3a46ea-c8f5-49c3-bb7b-ac91e3eb2880 GOVERNANCE
  ...
  (defconst POOL_ID:string "7c3a46ea-c8f5-49c3-bb7b-ac91e3eb2880"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-7c3a46ea-c8f5-49c3-bb7b-ac91e3eb2880"
  ...
  (defconst MAX_RAISE:decimal 0.200000000000
  ...
  (defconst MAX_ALLOCATION:decimal 0.200000000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-01-21T19:35:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-22T19:35:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-23T19:35:00Z")
