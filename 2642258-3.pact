(module backalley-dev-1d44f519-0769-473f-8e1a-75be035160ee GOVERNANCE
  ...
  (defconst POOL_ID:string "1d44f519-0769-473f-8e1a-75be035160ee"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-1d44f519-0769-473f-8e1a-75be035160ee"
  ...
  (defconst OWNER:string "k:7af2e1c72829322cc492027afedb8c8273081cf3fad7c040d53bf15d96fd2dfa"
  ...
  (defconst START_DATE:time (time "2022-01-24T18:15:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-01-24T18:25:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-01-24T18:25:00Z")
