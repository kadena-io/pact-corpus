(module better-testnet GOV
    "Secret Garden of Kadena NFTs"
  
    (defconst NFTS_TO_MINT_COUNT 1050.0)  
    (defconst WL_MINT_PRICE 0.0)
    (defconst PUBLIC_MINT_PRICE 0.0)
    (defconst WL_MINT_START_TIME "2023-02-12T19:00:00Z")
    (defconst PUBLIC_MINT_START_TIME "2023-02-13T19:00:00Z")
    (defconst MINT_END_TIME "2023-02-13T20:00:00Z")
    (defconst TRADING_START_TIME "2023-02-13T20:00:00Z")
    (defconst MAX_WL_MINT 3)
    ...
    (defconst OFFERS_BANK:string "butter-testnet-offers-bank")
    (defconst ADMIN_KEYSET "free.butter-testnet-admin")
    (defconst ADMIN_ADDRESS "k:04e21d9dbe39517574a3772de910d606baa00a84359ba6c468206c76695650d4")
    (defconst CREATOR_ADDRESS "k:04e21d9dbe39517574a3772de910d606baa00a84359ba6c468206c76695650d4")
    (defconst ROYALTY_FEE 0.01)
    (defconst IMAGES_URI "https://arkade-prod.s3.us-east-1.amazonaws.com/secret-garden-of-kadena/")
