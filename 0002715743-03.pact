(module backalley-dev-3ba66a21-accb-45d7-8c1a-d5881543c3ad GOVERNANCE
  ...
  (defconst POOL_ID:string "3ba66a21-accb-45d7-8c1a-d5881543c3ad"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-3ba66a21-accb-45d7-8c1a-d5881543c3ad"
  ...
  (defconst START_DATE:time (time "2022-02-10T23:15:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-10T23:45:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-10T23:45:00Z")
