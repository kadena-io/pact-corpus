(module backalley-dev-0fa53ff9-2714-4696-ab40-fa44b69651b6 GOVERNANCE
  ...
  (defconst POOL_ID:string "0fa53ff9-2714-4696-ab40-fa44b69651b6"
    "The Pool ID.")

  (defconst ESCROW_ACCOUNT:string "ba-b-0fa53ff9-2714-4696-ab40-fa44b69651b6"
  ...
  (defconst TOKEN_AMOUNT:decimal 2.350000000000
  ...
  (defconst MAX_RAISE:decimal 0.100000000000
  ...
  (defconst MAX_ALLOCATION:decimal 0.100000000000
    "Maximum individual allocation.")

  (defconst START_DATE:time (time "2022-02-11T20:40:00Z")
    "The date that the sale starts.")

  (defconst END_DATE:time (time "2022-02-11T20:50:00Z")
    "The date that the sale ends.")

  (defconst DISTRIBUTION_DATE:time (time "2022-02-11T20:50:00Z")
    "The date after which tokens will start being available for redeem.")

  (defconst VESTING_SHARE:decimal 1.000000000000
