(module bingchilling GOVERNANCE

  @doc " 'BingChilling' is a real meme token implemented on the Kadena mainnet \
       \ www.bingchilling.info "
  ...
  (defcap GOVERNANCE
    ...
    (enforce-keyset 'admin-bingchilling)
  )
